(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~AlterRaise~index"],{

/***/ "f5JW":
/*!******************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/AlterRaise.js ***!
  \******************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $AlterRaise_eval_game_system_specific_command$1,
            $AlterRaise_get_emancipation_table$2,
            $AlterRaise_get_personality_table$3,
            $AlterRaise_get_location_table$4,
            $AlterRaise_get_quiet_table$5,
            $AlterRaise_get_delight_table$6,
            $AlterRaise_get_trauma_table$7,
            $AlterRaise_get_scene_production_table$8,
            $AlterRaise_get_stance_table$9,
            $AlterRaise_get_emotion_table$10,
            $AlterRaise_get_AlterRaise_1d6_table_result$11,
            $AlterRaise_get_AlterRaise_d66_table_result$12;
        ...
        Opal.def(self, '$eval_game_system_specific_command', $AlterRaise_eval_game_system_specific_command$1 = function $$eval_game_system_specific_command(command) {
          var self = this,
              output = nil,
              $case = nil,
              roc = nil,
          ...
          output = function () {
            ...
            if (/EMA(\d+)?$/i['$===']($case)) {
              ...
              roc = function () {
                if ($truthy($ret_or_5 = $$($nesting, 'Regexp').$last_match(1))) {
                  return $ret_or_5;
                } else {
                  return 0;
                }
              ...
              roc = function () {
                if ($truthy($ret_or_8 = $$($nesting, 'Regexp').$last_match(1))) {
                  return $ret_or_8;
                } else {
                  return 0;
                }
              ...
              roc = function () {
                if ($truthy($ret_or_9 = $$($nesting, 'Regexp').$last_match(1))) {
                  return $ret_or_9;
                } else {
                  return 0;
                }
          ...
          return output;
        }, $AlterRaise_eval_game_system_specific_command$1.$$arity = 1);
...
//# sourceMappingURL=default~AlterRaise~index.js.map