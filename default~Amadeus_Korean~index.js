(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Amadeus_Korean~index"],{

/***/ "z9fX":
/*!**********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Amadeus_Korean.js ***!
  \**********************************************************************/
...
Opal.modules["bcdice/game_system/Amadeus"] = function (Opal) {
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        Opal.def(self, '$initialize', $Amadeus_Korean_initialize$1 = function $$initialize(command) {
          var $iter = $Amadeus_Korean_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $Amadeus_Korean_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $Amadeus_Korean_initialize$1, false, true), 'initialize', [command], null);
          return self.locale = "ko_kr";
        }, $Amadeus_Korean_initialize$1.$$arity = 1);
        self.$register_prefix_from_super_class();
        return Opal.const_set($nesting[0], 'TABLES', self.$translate_tables("ko_kr"));
      })($nesting[0], $$($nesting, 'Amadeus'), $nesting);
    })($nesting[0], $nesting);
  }($nesting[0], $nesting);
})(Opal);
...
//# sourceMappingURL=default~Amadeus_Korean~index.js.map