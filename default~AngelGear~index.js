(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~AngelGear~index"],{

/***/ "IznK":
/*!*****************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/AngelGear.js ***!
  \*****************************************************************/
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            ...
            $Parser__reduce_8$9,
            $Parser__reduce_9$10,
            $Parser__reduce_10$11,
            $Parser__reduce_11$12,
            $Parser__reduce_12$13,
            $Parser__reduce_13$14,
            $Parser__reduce_15$15,
            $Parser__reduce_16$16,
            $Parser__reduce_none$17,
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function (self, $parent_nesting) {
        var $nesting = [self].concat($parent_nesting),
            $eval$1;
        return (Opal.def(self, '$eval', $eval$1 = function $eval$1(source, round_type) {
          var $a,
              self = this,
              node = nil;
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $AngelGear_initialize$1,
            $AngelGear_eval_game_system_specific_command$2,
            $AngelGear_resolute_action$3;
        ...
        Opal.def(self, '$initialize', $AngelGear_initialize$1 = function $$initialize(command) {
          var $iter = $AngelGear_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
        ...
        Opal.def(self, '$resolute_action', $AngelGear_resolute_action$3 = function $$resolute_action(num_dice, skill_value, modify, command) {
          ...
          if ($truthy(skill_value)) {
            success = $send(dice, 'count', [], (_$$8 = function $$4(val) {
...
//# sourceMappingURL=default~AngelGear~index.js.map