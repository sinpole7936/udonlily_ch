(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~BadLife~index"],{

/***/ "DIEu":
/*!***************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/BadLife.js ***!
  \***************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $BadLife_eval_game_system_specific_command$1,
            $BadLife_judgeDice$2,
            $BadLife_get_critival_fumble$3,
            $BadLife_checkRoll$4,
            $BadLife_get_name_table$5,
            $BadLife_get_skill_table$6,
            $BadLife_get_badlife_1d20_table_result$7,
            $BadLife_get_badlife_table_result$8,
            $BadLife_get_value$9;
        ...
        Opal.def(self, '$judgeDice', $BadLife_judgeDice$2 = function $$judgeDice(command) {
          ...
          if ($truthy(m = /(\d+)?(BAD|BL|GL)([-+\d]*)((C|F)([-+\d]*)?)?((C|F)([-+\d]*))?(@([-+\d]*))?(!(\D*))?/i.$match(command))) {} else {
            return nil;
          }
        ...
        Opal.def(self, '$checkRoll', $BadLife_checkRoll$4 = function $$checkRoll(diceCount, modify, critical, fumble, target, isStormy, optionalText) {
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_3 = isHeavyAttack)) {
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_4 = isAnticipation)) {
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_5 = isAnticipation)) {
              return $rb_le(diceMax, 7);
            } else {
              return $ret_or_5;
            }
...
//# sourceMappingURL=default~BadLife~index.js.map