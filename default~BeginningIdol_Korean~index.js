(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~BeginningIdol_Korean~index"],{

/***/ "t9hM":
/*!****************************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/BeginningIdol_Korean.js ***!
  \****************************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $BeginningIdol_Korean_initialize$1,
            $BeginningIdol_Korean_check_nD6$2,
            $BeginningIdol_Korean_eval_game_system_specific_command$3,
            $BeginningIdol_Korean_rollPerformance$5,
            $BeginningIdol_Korean_textFromD66Table$7,
            $BeginningIdol_Korean_checkChance$8,
            $BeginningIdol_Korean_textFrom1D6Table$9,
            $BeginningIdol_Korean_getSkillList$11,
            $BeginningIdol_Korean_badStatus$12,
            $BeginningIdol_Korean_getSkillText$14,
            $BeginningIdol_Korean_setArrayFromD66Table$15,
            $BeginningIdol_Korean_getItem$16,
            $BeginningIdol_Korean_replaceBadStatus$18,
            $BeginningIdol_Korean_costume$19;
        ...
        self.$register_prefix("[1-7]*PD", "HW", "BWT", "LWT", "TWT", "CWT", "LO", "SU", "WI", "NA", "GA", "BA", "WT", "VA", "MU", "DR", "VI", "SP", "CHR", "PAR", "SW", "AN", "MOV", "FA", "HA", "AT[1-6]?", "LUR", "SUR", "WUR", "NUR", "GUR", "BUR", "BT", "SGT", "RS", "SH", "MO", "SEA", "SPA", "TN", "CG", "GG", "FL", "LN", "MS", "MSE", "ST", "FST", "CHO", "SCH", "WCH", "NCH", "IT", "ACT", "ACB", "ACE", "DT", "RC", "FC", "CBT", "RCB", "HBT", "RHB", "RU", "\\d{2}C", "BU", "\\d+S?A", "SIP", "BVT", "LVT", "TVT", "CVT", "BST", "LST", "TST", "CST", "BPT", "LPT", "TPT", "CPT", "BIT", "LIT", "TIT", "CIT");
        Opal.def(self, '$initialize', $BeginningIdol_Korean_initialize$1 = function $$initialize(command) {
          var $iter = $BeginningIdol_Korean_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $BeginningIdol_Korean_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $BeginningIdol_Korean_initialize$1, false, true), 'initialize', [command], null);
          self.sort_add_dice = true;
          return self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'ASC');
        }, $BeginningIdol_Korean_initialize$1.$$arity = 1);
        ...
        Opal.def(self, '$eval_game_system_specific_command', $BeginningIdol_Korean_eval_game_system_specific_command$3 = function $$eval_game_system_specific_command(command) {
          var $a,
              $b,
              _$$,
              self = this,
          ...
          if (/^([1-7]*)PD(\d+)([+\-]\d+)?$/['$===']($case)) {
            ...
            if ($truthy(articleIndex['$nil?']())) {} else {
            ...
            nameParts['$sort!']();
            numberString = "";
            $send(nameParts, 'each', [], (_$$ = function $$4(_index, src, text1, number1) {
              ...
              return numberString = $rb_plus(numberString, "" + src + number1 + ",");
            }, _$$.$$s = self, _$$.$$arity = 4, _$$));
            ...
            counts = function () {
              if ($truthy($ret_or_2 = $$($nesting, 'Regexp').$last_match(1))) {
                return $ret_or_2;
              } else {
                return 1;
              }
            ...
            return self.$costume("의상(챌린지 걸즈)");
          } else if ("RC"['$===']($case)) {
            return self.$costume("의상(로드 투 프린스)");
          } else if ("FC"['$===']($case)) {
            return self.$costume("의상(フォーチュンスターズ)");
          } else if ("CBT"['$===']($case)) {
            title = "캐릭터공백표(챌린지 걸즈)";
            ...
            if ($truthy(function () {
              if ($truthy($ret_or_3 = $rb_lt(degrees, 45))) {
                return $ret_or_3;
              } else {
                return $rb_gt(degrees, 55);
              }
            ...
            remove = $send($$($nesting, 'Regexp').$last_match(3).$each_char(), 'map', [], "to_i".$to_proc());
            adjust = ($a = $$($nesting, 'Regexp').$last_match(4), $a === nil || $a == null ? nil : $send($a, 'to_i', []));
            adjust_str = $$($nesting, 'Format').$modifier(adjust);
            ...
            if ($truthy(function () {
              if ($truthy($ret_or_4 = dice.$count()['$=='](counts))) {
                return $ret_or_4;
              } else {
                return dice['$empty?']();
              }
            ...
            if ($truthy(function () {
              if ($truthy($ret_or_5 = sure)) {
                return $ret_or_5;
              } else {
                return dice.$count()['$=='](dice.$uniq().$count());
              }
          ...
          ;
          return nil;
        }, $BeginningIdol_Korean_eval_game_system_specific_command$3.$$arity = 1);
        Opal.def(self, '$rollPerformance', $BeginningIdol_Korean_rollPerformance$5 = function $$rollPerformance(counts, residual, adjust) {
          ...
          diceAll = $rb_plus(dice_list.$join(""), residual);
          total = 0;
          diceUse = [];
          $send($range(1, 7, false), 'each', [], (_$$2 = function $$6(i) {
          ...
          if (total['$=='](0)) {
            ...
            if ($truthy($ret_or_6 = total['$=='](21))) {
              return diceUse['$include?'](7)['$!']();
            } else {
              return $ret_or_6;
            }
            ...
            if ($truthy(function () {
              if ($truthy($ret_or_7 = residual['$empty?']())) {
                return diceUse.$count()['$=='](diceAll.$length());
              } else {
                return $ret_or_7;
              }
        ...
        Opal.def(self, '$checkChance', $BeginningIdol_Korean_checkChance$8 = function $$checkChance(text, skill, chance) {
          ...
          if ($truthy(text['$=~'](/チャンスが(\d{1,2})以下なら오프。/))) {} else {
            return [text, skill];
          }

          ;
          target = $$($nesting, 'Regexp').$last_match(1).$to_i();
          matchedText = $$($nesting, 'Regexp').$last_match(0);
        ...
        Opal.def(self, '$textFrom1D6Table', $BeginningIdol_Korean_textFrom1D6Table$9 = function $$textFrom1D6Table(title, table1, table2) {
          ...
          if ($truthy(/랜덤으로 지정한 특기가 지정 특기인 아이돌 스킬\(신장분야、(속성|재능)분야、출신분야가 나올경우 재굴림\)$/['$=~'](text))) {
            ...
            (function () {
              ...
              try {
                return $send(self, 'loop', [], (_$$3 = function $$10() {
                  ...
                  if ($truthy(function () {
                    if ($truthy($ret_or_8 = function () {
                      if ($truthy($ret_or_9 = skill['$include?']("신장"))) {
                        return $ret_or_9;
                      } else {
                        return skill['$include?'](category);
                      }
                  ...
                  ;
                  return text = $rb_plus(text, " ＞ 振り直し");
                }, _$$3.$$s = self, _$$3.$$brk = $brk, _$$3.$$arity = 0, _$$3));
              } catch (err) {
                if (err === $brk) {
                  return err.$v;
                } else {
        ...
        Opal.def(self, '$badStatus', $BeginningIdol_Korean_badStatus$12 = function $$badStatus(counts) {
          ...
          ;
          $send(occurrences, 'times', [], (_$$4 = function $$13(i) {
            ...
            ;
            return text = $rb_plus(text, $rb_plus(table['$[]']($rb_minus(numbers['$[]'](i), 1)), "\n"));
        ...
        Opal.def(self, '$getItem', $BeginningIdol_Korean_getItem$16 = function $$getItem(counts) {
          ...
          ;
          numbers = self.randomizer.$roll_barabara(counts, 6).$sort();
          unique = numbers.$uniq();
          text = "" + title + " ＞ [" + numbers.$join(",") + "] ＞ ";
          acquisitions = numbers.$count();
          kinds = unique.$count();
          $send(kinds, 'times', [], (_$$5 = function $$17(i) {
        ...
        Opal.def(self, '$replaceBadStatus', $BeginningIdol_Korean_replaceBadStatus$18 = function $$replaceBadStatus(text) {
          ...
          if ($truthy(/変調がランダムに(一|二|三)つ発生する。/['$=~'](text))) {} else {
            return text;
          }
          ...
          substitution = substitution.$gsub($$($nesting, 'Regexp').$last_match(0), "");

          if ($truthy(function () {
            if ($truthy($ret_or_11 = substitution['$empty?']())) {
              return $ret_or_11;
            } else {
              return /\n$/['$=~'](substitution);
            }
...
//# sourceMappingURL=default~BeginningIdol_Korean~index.js.map