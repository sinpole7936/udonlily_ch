(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~BeginningIdol~index"],{

/***/ "VjH8":
/*!*********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/BeginningIdol.js ***!
  \*********************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $BeginningIdol_initialize$1,
            $BeginningIdol_check_nD6$2,
            $BeginningIdol_eval_game_system_specific_command$3,
            $BeginningIdol_rollPerformance$5,
            $BeginningIdol_textFromD66Table$7,
            $BeginningIdol_checkChance$8,
            $BeginningIdol_textFrom1D6Table$9,
            $BeginningIdol_getSkillList$11,
            $BeginningIdol_badStatus$12,
            $BeginningIdol_getSkillText$14,
            $BeginningIdol_setArrayFromD66Table$15,
            $BeginningIdol_getItem$16,
            $BeginningIdol_replaceBadStatus$18,
            $BeginningIdol_costume$19;
        ...
        self.$register_prefix("[1-7]*PD", "HW", "BWT", "LWT", "TWT", "CWT", "LO", "SU", "WI", "NA", "GA", "BA", "WT", "VA", "MU", "DR", "VI", "SP", "CHR", "PAR", "SW", "AN", "MOV", "FA", "RE", "HA", "AT[1-6]?", "LUR", "SUR", "WUR", "NUR", "GUR", "BUR", "BT", "SGT", "RS", "SH", "MO", "SEA", "SPA", "TN", "CG", "GG", "FL", "LN", "MS", "MSE", "ST", "FST", "CHO", "SCH", "WCH", "NCH", "GCH", "PCH", "IT", "ACT", "ACB", "ACE", "DT", "RC", "FC", "CBT", "RCB", "HBT", "RHB", "RU", "\\d{2}C", "BU", "\\d+S?A", "SIP", "BVT", "LVT", "TVT", "CVT", "BST", "LST", "TST", "CST", "BPT", "LPT", "TPT", "CPT", "BIT", "LIT", "TIT", "CIT");
        Opal.def(self, '$initialize', $BeginningIdol_initialize$1 = function $$initialize(command) {
          var $iter = $BeginningIdol_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $BeginningIdol_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $BeginningIdol_initialize$1, false, true), 'initialize', [command], null);
          self.sort_add_dice = true;
          return self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'ASC');
        }, $BeginningIdol_initialize$1.$$arity = 1);
        ...
        Opal.def(self, '$eval_game_system_specific_command', $BeginningIdol_eval_game_system_specific_command$3 = function $$eval_game_system_specific_command(command) {
          var $a,
              $b,
              _$$,
              self = this,
          ...
          if (/^([1-7]*)PD(\d+)([+\-]\d+)?$/['$===']($case)) {
            ...
            ;
            dice = self.randomizer.$roll_d66($$$($$($nesting, 'D66SortType'), 'NO_SORT'));
            ...
            return self.$costume("衣装(チャレンジガールズ)");
          } else if ("RC"['$===']($case)) {
            return self.$costume("衣装(ロードトゥプリンス)");
          } else if ("FC"['$===']($case)) {
            return self.$costume("衣装(フォーチュンスターズ)");
          } else if ("CBT"['$===']($case)) {
          ...
          ;
          return nil;
        }, $BeginningIdol_eval_game_system_specific_command$3.$$arity = 1);
        ...
        Opal.def(self, '$checkChance', $BeginningIdol_checkChance$8 = function $$checkChance(text, skill, chance) {
          ...
          if ($truthy(text['$=~'](/チャンスが(\d{1,2})以下ならオフ。/))) {} else {
            return [text, skill];
          }
                ...
                return $send(self, 'loop', [], (_$$3 = function $$10() {
                  ...
                  if ($truthy(function () {
                    if ($truthy($ret_or_8 = function () {
                      if ($truthy($ret_or_9 = skill['$include?']("身長"))) {
                        return $ret_or_9;
                      } else {
...
//# sourceMappingURL=default~BeginningIdol~index.js.map