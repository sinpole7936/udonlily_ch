(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~ColossalHunter~index"],{

/***/ "9vgR":
/*!**********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/ColossalHunter.js ***!
  \**********************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $ColossalHunter_initialize$1,
            $ColossalHunter_eval_game_system_specific_command$2,
            $ColossalHunter_getCheckRollDiceCommandResult$3,
            $ColossalHunter_getJudgeResultString$4,
            $ColossalHunter_getValue$5,
            $ColossalHunter_isCritical$6,
            $ColossalHunter_isFamble$7,
            $ColossalHunter_getSourceSceneDiceCommandResult$8,
            $ColossalHunter_getYearTableResult$9,
            $ColossalHunter_getYear$10,
            $ColossalHunter_getD6xResult$12,
            $ColossalHunter_getBig6Table$15,
            $ColossalHunter_getCreateNpcDiceCommandResult$16,
            $ColossalHunter_getD66Item$17,
            $ColossalHunter_getTableDiceCommandResult$18;
        ...
        Opal.def(self, '$initialize', $ColossalHunter_initialize$1 = function $$initialize(command) {
          var $iter = $ColossalHunter_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $ColossalHunter_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $ColossalHunter_initialize$1, false, true), 'initialize', [command], null);
          return self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'NO_SORT');
        }, $ColossalHunter_initialize$1.$$arity = 1);
        Opal.def(self, '$eval_game_system_specific_command', $ColossalHunter_eval_game_system_specific_command$2 = function $$eval_game_system_specific_command(command) {
          var self = this,
              $ret_or_1 = nil,
              $ret_or_2 = nil,
              $ret_or_3 = nil;
          ...
          if ($truthy($ret_or_1 = function () {
            if ($truthy($ret_or_2 = function () {
              if ($truthy($ret_or_3 = self.$getCheckRollDiceCommandResult(command))) {
                return $ret_or_3;
              } else {
                return self.$getSourceSceneDiceCommandResult(command);
              }
              ...
              return self.$getCreateNpcDiceCommandResult(command);
            }
        ...
        }, $ColossalHunter_eval_game_system_specific_command$2.$$arity = 1);
        Opal.def(self, '$getCheckRollDiceCommandResult', $ColossalHunter_getCheckRollDiceCommandResult$3 = function $$getCheckRollDiceCommandResult(command) {
          ...
          if ($truthy(command['$=~'](/(\d+)?CH([+\-\d]*)(>=([+\-\d]*))?$/i))) {} else {
            return nil;
          }
          ...
          diceCount = function () {
            if ($truthy($ret_or_4 = $$($nesting, 'Regexp').$last_match(1))) {
              return $ret_or_4;
            } else {
              return 3;
            }
          ...
          modifyText = function () {
            if ($truthy($ret_or_5 = $$($nesting, 'Regexp').$last_match(2))) {
              return $ret_or_5;
            } else {
              return "";
            }
        ...
        Opal.def(self, '$getYear', $ColossalHunter_getYear$10 = function $$getYear(yearText) {
          ...
          text = $send(yearText, 'gsub', [/(\d+)D(6+)/], (_$$ = function $$11() {
            var self = _$$.$$s == null ? this : _$$.$$s;
            return self.$getD6xResult($$($nesting, 'Regexp').$last_match(1).$to_i(), $$($nesting, 'Regexp').$last_match(2).$length());
          }, _$$.$$s = self, _$$.$$arity = 0, _$$));

          if ($truthy(text['$match?'](/^[+\-*\/\d]+$/))) {} else {
            return nil;
          }
          ...
          ;
          year = $$($nesting, 'ArithmeticEvaluator').$eval(text);
          return [year, "" + "(" + text + ")"];
        ...
        Opal.def(self, '$getD6xResult', $ColossalHunter_getD6xResult$12 = function $$getD6xResult(count, dice6Count) {
          ...
          total = 0;
          $send(count, 'times', [], (_$$3 = function $$13(_i) {
            ...
            ;
            number = 0;
            $send(dice6Count, 'times', [], (_$$2 = function $$14(_i) {
              ...
              return number = $rb_plus(number, dice);
            }, _$$2.$$s = self, _$$2.$$arity = 1, _$$2));
            return total = $rb_plus(total, number);
        ...
        Opal.def(self, '$getTableDiceCommandResult', $ColossalHunter_getTableDiceCommandResult$18 = function $$getTableDiceCommandResult(command) {
          ...
          }(), $a = Opal.to_ary($b), text = $a[0] == null ? nil : $a[0], number = $a[1] == null ? nil : $a[1], $b;
...
//# sourceMappingURL=default~ColossalHunter~index.js.map