(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Cthulhu_Korean~index"],{

/***/ "jYl8":
/*!**********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Cthulhu_Korean.js ***!
  \**********************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        return (Opal.def(self, '$initialize', $Cthulhu_Korean_initialize$1 = function $$initialize(command) {
          var $iter = $Cthulhu_Korean_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $Cthulhu_Korean_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $Cthulhu_Korean_initialize$1, false, true), 'initialize', [command], null);
          return self.locale = "ko_kr";
        }, $Cthulhu_Korean_initialize$1.$$arity = 1), nil) && 'initialize';
...
//# sourceMappingURL=default~Cthulhu_Korean~index.js.map