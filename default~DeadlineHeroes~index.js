(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~DeadlineHeroes~index"],{

/***/ "3p2c":
/*!**********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/DeadlineHeroes.js ***!
  \**********************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $DeadlineHeroes_eval_game_system_specific_command$1,
            $DeadlineHeroes_resolute_action$2,
            $DeadlineHeroes_action_result$3,
            $DeadlineHeroes_roll_d100$4,
            $DeadlineHeroes_roll_death_chart$8,
            $DeadlineHeroes_roll_hero_name_chart$13;
        ...
        Opal.def(self, '$eval_game_system_specific_command', $DeadlineHeroes_eval_game_system_specific_command$1 = function $$eval_game_system_specific_command(command) {
          var self = this,
              $case = nil;
          return function () {
            $case = command;
        ...
        }, $DeadlineHeroes_eval_game_system_specific_command$1.$$arity = 1);
        self.$private();
        Opal.def(self, '$resolute_action', $DeadlineHeroes_resolute_action$2 = function $$resolute_action(command) {
          ...
          ;
          success_rate = $$($nesting, 'ArithmeticEvaluator').$eval(m['$[]'](1));
        ...
        Opal.def(self, '$action_result', $DeadlineHeroes_action_result$3 = function $$action_result(total, tens, ones, success_rate) {
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_1 = total['$=='](100))) {
              return $ret_or_1;
            } else {
              return $rb_le(success_rate, 0);
            }
        ...
        (function ($base, $super, $parent_nesting) {
          ...
          Opal.def(self, '$roll', $DeathChart_roll$6 = function $$roll(randomizer, minus_score) {
            var $a,
                $b,
                self = this,
                dice = nil,
        ...
        Opal.const_set($nesting[0], 'DEATH_CHARTS', $hash2(["L", "S", "C"], {
          "L": $$($nesting, 'DeathChart').$new("肉体", ["何も無し。キミは奇跡的に一命を取り留めた。闘いは続く。", "激痛が走る。以後、イベント終了時まで、全ての判定の成功率－10％。", "キミは［硬直］ポイント２点を得る。［硬直］ポイントを所持している間、キミは「属性：妨害」のパワーを使用することができない。各ラウンド終了時、キミは所持している［硬直］ポイントを１点減らしてもよい。", "渾身の一撃!!　キミは〈生存〉判定を行なう。失敗した場合、［死亡］する。", "キミは［気絶］ポイント２点を得る。［気絶］ポイントを所持している間、キミはあらゆるパワーを使用できず、自身のターンを得ることもできない。各ラウンド終了時、キミは所持している［気絶］ポイントを１点減らしてもよい。", "以後、イベント終了時まで、全ての判定の成功率－20％。", "記録的一撃!!　キミは〈生存〉－20％の判定を行なう。失敗した場合、［死亡］する。", "キミは［瀕死］ポイント２点を得る。［瀕死］ポイントを所持している間、キミはあらゆるパワーを使用できず、自身のターンを得ることもできない。各ラウンド終了時、キミは所持している［瀕死］ポイントを１点を失う。全ての［瀕死］ポイントを失う前に戦闘が終了しなかった場合、キミは［死亡］する。", "叙事詩的一撃!!　キミは〈生存〉－30％の判定を行なう。失敗した場合、［死亡］する。", "以後、イベント終了時まで、全ての判定の成功率－30％。", "神話的一撃!!　キミは宙を舞って三回転ほどした後、地面に叩きつけられる。見るも無惨な姿。肉体は原型を留めていない（キミは［死亡］した）。"]),
          "S": $$($nesting, 'DeathChart').$new("精神", ["何も無し。キミは歯を食いしばってストレスに耐えた。", "以後、イベント終了時まで、全ての判定の成功率－10％。", "キミは［恐怖］ポイント２点を得る。［恐怖］ポイントを所持している間、キミは「属性：攻撃」のパワーを使用できない。各ラウンド終了時、キミは所持している［恐怖］ポイントを１点減らしてもよい。", "とても傷ついた。キミは〈意志〉判定を行なう。失敗した場合、［絶望］してＮＰＣとなる。", "キミは［気絶］ポイント２点を得る。［気絶］ポイントを所持している間、キミはあらゆるパワーを使用できず、自身のターンを得ることもできない。各ラウンド終了時、キミは所持している［気絶］ポイントを１点減らしてもよい。", "以後、イベント終了時まで、全ての判定の成功率－20％。", "信じるものに裏切られたような痛み。キミは〈意志〉－20％の判定を行なう。失敗した場合、［絶望］してＮＰＣとなる。", "キミは［混乱］ポイント２点を得る。［混乱］ポイントを所持している間、キミは本来味方であったキャラクターに対して、可能な限り最大の被害を与える様、行動し続ける。各ラウンド終了時、キミは所持している［混乱］ポイントを１点減らしてもよい。", "あまりに残酷な現実。キミは〈意志〉－30％の判定を行なう。失敗した場合、［絶望］してＮＰＣとなる。", "以後、イベント終了時まで、全ての判定の成功率－30％。", "宇宙開闢の理に触れるも、それは人類の認識限界を超える何かであった。キミは［絶望］し、以後ＮＰＣとなる。"]),
          "C": $$($nesting, 'DeathChart').$new("環境", ["何も無し。キミは黒い噂を握りつぶした。", "以後、イベント終了時まで、全ての判定の成功率－10％。", "ピンチ！　以後、イベント終了時まで、キミは《支援》を使用できない。", "裏切り!!　キミは〈経済〉判定を行なう。失敗した場合、キミはヒーローとしての名声を失い、［汚名］を受ける。", "以後、シナリオ終了時まで、代償にクレジットを消費するパワーを使用できない。", "キミの悪評は大変なもののようだ。協力者からの支援が打ち切られる。以後、シナリオ終了時まで、全ての判定の成功率－20％。", "信頼の失墜!!　キミは〈経済〉－20％の判定を行なう。失敗した場合、キミはヒーローとしての名声を失い、［汚名］を受ける。", "以後、シナリオ終了時まで、【環境】系の技能のレベルがすべて０となる。", "捏造報道!!　身の覚えのない犯罪への荷担が、スクープとして報道される。キミは〈経済〉－30％の判定を行なう。失敗した場合、キミはヒーローとしての名声を失い、［汚名］を受ける。", "以後、イベント終了時まで、全ての判定の成功率－30％。", "キミの名は史上最悪の汚点として永遠に歴史に刻まれる。もはやキミを信じる仲間はなく、キミを助ける社会もない。キミは［汚名］を受けた。"])
        }).$freeze());

        (function ($base, $super, $parent_nesting) {
          var self = $klass($base, $super, 'RealNameChart');
          var $nesting = [self].concat($parent_nesting),
              $RealNameChart_initialize$9,
              $RealNameChart_mix_column$11;
          Opal.def(self, '$initialize', $RealNameChart_initialize$9 = function $$initialize(name, columns, chart) {
            var _$$7,
                $iter = $RealNameChart_initialize$9.$$p,
                $yield = $iter || nil,
                self = this,
                items = nil;

            if ($iter) $RealNameChart_initialize$9.$$p = null;
            items = $send(chart, 'map', [], (_$$7 = function $$10(l) {
              ...
              ;
              return self.$mix_column(columns, l);
            }, _$$7.$$s = self, _$$7.$$arity = 1, _$$7));
            return $send2(self, Opal.find_super_dispatcher(self, 'initialize', $RealNameChart_initialize$9, false, true), 'initialize', [name, "1D100", items], null);
          ...
          return (Opal.def(self, '$mix_column', $RealNameChart_mix_column$11 = function $$mix_column(columns, item) {
            ...
            ;
            candidate = $send(columns.$zip(names), 'map', [], (_$$8 = function $$12(l) {
        ...
        Opal.def(self, '$roll_hero_name_chart', $DeadlineHeroes_roll_hero_name_chart$13 = function $$roll_hero_name_chart() {
          ...
          elements = [];
          $send(template['$[]']("elements"), 'each', [], (_$$9 = function $$14(type) {
            ...
            ;
            $b = base_chart.$roll(self.randomizer), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], element = $a[1] == null ? nil : $a[1], $b;
            results.$push(result);
        ...
        Opal.const_set($nesting[0], 'HERO_NAME_TEMPLATES', [$hash2(["text", "elements"], {
          "text": "ベースＡ＋ベースＡ",
          "elements": ["ベースＡ", "ベースＢ"]
        }), $hash2(["text", "elements"], {
          "text": "ベースＢ",
        ...
        (function ($base, $super, $parent_nesting) {
          ...
          var $nesting = [self].concat($parent_nesting),
              $HeroNameBaseChart_initialize$15,
              $HeroNameBaseChart_roll$16;
          ...
          return (Opal.def(self, '$roll', $HeroNameBaseChart_roll$16 = function $$roll(randomizer) {
            var $a,
                $b,
                self = this,
                dice = nil,
            ...
            if ($truthy(m = chosen.$match(/^［(.+)］$/))) {
              ...
              $b = element_chart.$roll(randomizer), $a = Opal.to_ary($b), element_result = $a[0] == null ? nil : $a[0], chosen = $a[1] == null ? nil : $a[1], $b;
        ...
        (function ($base, $super, $parent_nesting) {
          ...
          var $nesting = [self].concat($parent_nesting),
              $HeroNameElementChart_initialize$17,
              $HeroNameElementChart_roll$18;
          self.$$prototype.items = self.$$prototype.name = nil;
          ...
          return (Opal.def(self, '$roll', $HeroNameElementChart_roll$18 = function $$roll(randomizer) {
            var self = this,
                dice = nil,
                chosen = nil,
                result = nil;
        ...
        Opal.const_set($nesting[0], 'HERO_NAME_BASE_CHARTS', $hash2(["ベースＡ", "ベースＢ", "ベースＣ"], {
          "ベースＡ": $$($nesting, 'HeroNameBaseChart').$new("ベースＡ", ["ザ・", "キャプテン・", "ミスター／ミス／ミセス・", "ドクター／プロフェッサー・", "ロード／バロン／ジェネラル・", "マン・オブ・", "［強さ］", "［色］", "マダム／ミドル・", "数字（1～10）・"]),
          "ベースＢ": $$($nesting, 'HeroNameBaseChart').$new("ベースＢ", ["［神話／夢］", "［武器］", "［動物］", "［鳥］", "［虫／爬虫類］", "［部位］", "［光］", "［攻撃］", "［その他］", "数字（1～10）・"]),
          "ベースＣ": $$($nesting, 'HeroNameBaseChart').$new("ベースＣ", ["マン／ウーマン", "ボーイ／ガール", "マスク／フード", "ライダー", "マスター", "ファイター／ソルジャー", "キング／クイーン", "［色］", "ヒーロー／スペシャル", "ヒーロー／スペシャル"])
        }).$freeze());
        return Opal.const_set($nesting[0], 'HERO_NAME_ELEMENT_CHARTS', $hash2(["部位", "武器", "色", "動物", "神話／夢", "攻撃", "その他", "鳥", "光", "虫／爬虫類", "強さ"], {
          "部位": $$($nesting, 'HeroNameElementChart').$new("部位", [$hash2(["element", "mean"], {
            "element": "ハート",
            "mean": "心臓"
          }), $hash2(["element", "mean"], {
            "element": "フェイス",
          ...
          "武器": $$($nesting, 'HeroNameElementChart').$new("武器", [$hash2(["element", "mean"], {
            "element": "ナイヴス",
            "mean": "短剣"
          }), $hash2(["element", "mean"], {
            "element": "ソード",
          ...
          "色": $$($nesting, 'HeroNameElementChart').$new("色", [$hash2(["element", "mean"], {
            "element": "ブラック",
            "mean": "黒"
          }), $hash2(["element", "mean"], {
            "element": "グリーン",
          ...
          "動物": $$($nesting, 'HeroNameElementChart').$new("動物", [$hash2(["element", "mean"], {
            "element": "バニー",
            "mean": "ウサギ"
          }), $hash2(["element", "mean"], {
            "element": "タイガー",
          ...
          "神話／夢": $$($nesting, 'HeroNameElementChart').$new("神話／夢", [$hash2(["element", "mean"], {
            "element": "アポカリプス",
            "mean": "黙示録"
          }), $hash2(["element", "mean"], {
            "element": "ウォー",
          ...
          "攻撃": $$($nesting, 'HeroNameElementChart').$new("攻撃", [$hash2(["element", "mean"], {
            "element": "ストローク",
            "mean": "一撃"
          }), $hash2(["element", "mean"], {
            "element": "クラッシュ",
          ...
          "その他": $$($nesting, 'HeroNameElementChart').$new("その他", [$hash2(["element", "mean"], {
            "element": "ヒューマン",
            "mean": "人間"
          }), $hash2(["element", "mean"], {
            "element": "エージェント",
          ...
          "鳥": $$($nesting, 'HeroNameElementChart').$new("鳥", [$hash2(["element", "mean"], {
            "element": "ホーク",
            "mean": "鷹"
          }), $hash2(["element", "mean"], {
            "element": "ファルコン",
          ...
          "光": $$($nesting, 'HeroNameElementChart').$new("光", [$hash2(["element", "mean"], {
            "element": "ライト",
            "mean": "光"
          }), $hash2(["element", "mean"], {
            "element": "シャドウ",
          ...
          "虫／爬虫類": $$($nesting, 'HeroNameElementChart').$new("虫／爬虫類", [$hash2(["element", "mean"], {
            "element": "ビートル",
            "mean": "甲虫"
          }), $hash2(["element", "mean"], {
            "element": "バタフライ／モス",
          ...
          "強さ": $$($nesting, 'HeroNameElementChart').$new("強さ", [$hash2(["element", "mean"], {
            "element": "スーパー／ウルトラ",
            "mean": "超"
          }), $hash2(["element", "mean"], {
            "element": "ワンダー",
...
//# sourceMappingURL=default~DeadlineHeroes~index.js.map