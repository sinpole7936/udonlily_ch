(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~GranCrest~index"],{

/***/ "dwqY":
/*!*****************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/GranCrest.js ***!
  \*****************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $GranCrest_initialize$1,
            $GranCrest_result_nd6$2,
            $GranCrest_eval_game_system_specific_command$3,
            $GranCrest_getMeetingTableResult$4,
            $GranCrest_getFeelingTableResult$5,
            $GranCrest_getCountryTableResult$6;
        ...
        self.$register_prefix("MT", "PFT", "NFT", "CT", "TCT", "ICT", "PCT", "OCT", "BCT", "CCT");
        Opal.def(self, '$initialize', $GranCrest_initialize$1 = function $$initialize(command) {
          var $iter = $GranCrest_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $GranCrest_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $GranCrest_initialize$1, false, true), 'initialize', [command], null);
          self.sort_add_dice = true;
          self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'NO_SORT');
          return self.round_type = $$$($$($nesting, 'RoundType'), 'FLOOR');
        }, $GranCrest_initialize$1.$$arity = 1);
        Opal.def(self, '$result_nd6', $GranCrest_result_nd6$2 = function $$result_nd6(total, _dice_total, dice_list, cmp_op, target) {
          var self = this,
              result = nil,
              sequence = nil,
              $writer = nil;
          ...
          ;
          return result;
        }, $GranCrest_result_nd6$2.$$arity = 5);
        Opal.def(self, '$eval_game_system_specific_command', $GranCrest_eval_game_system_specific_command$3 = function $$eval_game_system_specific_command(command) {
          var $a,
              $b,
              self = this,
              tableName = nil,
          ...
          if ("MT"['$===']($case)) {
            $b = self.$getMeetingTableResult(), $a = Opal.to_ary($b), tableName = $a[0] == null ? nil : $a[0], result = $a[1] == null ? nil : $a[1], number = $a[2] == null ? nil : $a[2], $b;
          } else if (/^.+FT$/i['$===']($case)) {
            $b = self.$getFeelingTableResult(command), $a = Opal.to_ary($b), tableName = $a[0] == null ? nil : $a[0], result = $a[1] == null ? nil : $a[1], number = $a[2] == null ? nil : $a[2], $b;
          } else if (/^.*CT$/i['$===']($case)) {
            $b = self.$getCountryTableResult(command), $a = Opal.to_ary($b), tableName = $a[0] == null ? nil : $a[0], result = $a[1] == null ? nil : $a[1], number = $a[2] == null ? nil : $a[2], $b;
          } else {
            self.$debug("eval_game_system_specific_command commandNOT matched -> command:", command);
            return "";
          }
          ...
          return text;
        }, $GranCrest_eval_game_system_specific_command$3.$$arity = 1);
        ...
        return (Opal.def(self, '$getCountryTableResult', $GranCrest_getCountryTableResult$6 = function $$getCountryTableResult(command) {
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_1 = /^CT$/i['$=~'](command))) {
              return $ret_or_1;
            } else {
              return /^CategoryCT$/i['$=~'](command);
            }
...
//# sourceMappingURL=default~GranCrest~index.js.map