(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~GundogRevised~index"],{

/***/ "ULLz":
/*!*********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/GundogRevised.js ***!
  \*********************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $GundogRevised_initialize$1,
            $GundogRevised_result_1d100$2,
            $GundogRevised_eval_game_system_specific_command$3,
            $GundogRevised_getDamageTypeAndTable$5,
            $GundogRevised_getFumbleTypeAndTable$6;
        ...
        Opal.def(self, '$initialize', $GundogRevised_initialize$1 = function $$initialize(command) {
          var $iter = $GundogRevised_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
        ...
        Opal.def(self, '$eval_game_system_specific_command', $GundogRevised_eval_game_system_specific_command$3 = function $$eval_game_system_specific_command(command) {
          ...
          dice = $rb_plus(mod, $send(diceArray, 'select', [], (_$$ = function $$4(x) {
...
//# sourceMappingURL=default~GundogRevised~index.js.map