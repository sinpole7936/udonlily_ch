(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~GurpsFW~index"],{

/***/ "7R9D":
/*!***************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/GurpsFW.js ***!
  \***************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $GurpsFW_initialize$1,
            $GurpsFW_result_nd6$2,
            $GurpsFW_eval_game_system_specific_command$3,
            $GurpsFW_normal1$4,
            $GurpsFW_normal2$8,
            $GurpsFW_normal3$11,
            $GurpsFW_normal4$13,
            ...
            $GurpsFW_premium5$28,
            $GurpsFW_premium6$30,
            $GurpsFW_getLotResult$31,
            $GurpsFW_getTresureTable$32,
            $GurpsFW_getTrapTable$33,
            $GurpsFW_getRandomEvent$34,
            $GurpsFW_getRandomDiff$35;
        ...
        Opal.def(self, '$initialize', $GurpsFW_initialize$1 = function $$initialize(command) {
          var $iter = $GurpsFW_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $GurpsFW_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $GurpsFW_initialize$1, false, true), 'initialize', [command], null);
          return self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'NO_SORT');
        }, $GurpsFW_initialize$1.$$arity = 1);
        Opal.def(self, '$result_nd6', $GurpsFW_result_nd6$2 = function $$result_nd6(total, dice_total, dice_list, cmp_op, target) {
          var self = this,
              $ret_or_1 = nil,
              success = nil,
              crt_string = nil,
          ...
          crt_string = $$($nesting, 'Result').$critical("" + "クリティカル(成功度：" + success + ")");
          fmb_string = $$($nesting, 'Result').$fumble("" + "ファンブル(失敗度：" + success + ")");
          fail_string = $$($nesting, 'Result').$failure("" + "自動失敗(失敗度：" + success + ")");

          if ($truthy(function () {
            if ($truthy($ret_or_2 = $rb_le(dice_total, 6))) {
            ...
            if ($truthy($ret_or_3 = $rb_le(dice_total, 5))) {
          ...
          if ($truthy($rb_le($rb_minus(target, dice_total), -10))) {
            ...
            if ($truthy($ret_or_4 = $rb_ge(dice_total, 17))) {
          ...
          ;
        }, $GurpsFW_result_nd6$2.$$arity = 5);
        Opal.def(self, '$eval_game_system_specific_command', $GurpsFW_eval_game_system_specific_command$3 = function $$eval_game_system_specific_command(string) {
          var $a,
              $b,
              self = this,
              tableName = nil,
          ...
          if ("CRT"['$===']($case)) {
            ...
            if ($truthy($$($nesting, 'Regexp').$last_match(4)['$nil?']())) {} else {
            ...
            if ($truthy($rb_le(number, 3))) {
              ...
              if ($truthy($ret_or_5 = $rb_le(number, 4))) {
                return mode['$==']("N");
              } else {
                return $ret_or_5;
              }
          ...
          return text;
        }, $GurpsFW_eval_game_system_specific_command$3.$$arity = 1);
        Opal.def(self, '$normal1', $GurpsFW_normal1$4 = function $$normal1() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["イレブンチキン", "イレブンチキン", "イレブンチキン", $send(self, 'lambda', [], ($$5 = function (_$$) {
            function $$5() {
            ...
            return self.$normal2().$to_s();
          }), $$5.$$s = self, $$5.$$arity = 0, $$5)), $send(self, 'lambda', [], ($$6 = function (_$$2) {
            function $$6() {
            ...
            return self.$normal2().$to_s();
          }), $$6.$$s = self, $$6.$$arity = 0, $$6)), $send(self, 'lambda', [], ($$7 = function (_$$3) {
            function $$7() {
            ...
            return self.$normal3().$to_s();
          }), $$7.$$s = self, $$7.$$arity = 0, $$7))];
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_normal1$4.$$arity = 0);
        Opal.def(self, '$normal2', $GurpsFW_normal2$8 = function $$normal2() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["バロールたわし", "イグニスジッポ", "ヤコ仮面or梟の文鎮(選択可)", "ナレッジのハンモックorジンジャビースト", $send(self, 'lambda', [], ($$9 = function (_$$4) {
            function $$9() {
            ...
            return self.$normal3().$to_s();
          }), $$9.$$s = self, $$9.$$arity = 0, $$9)), $send(self, 'lambda', [], ($$10 = function (_$$5) {
            function $$10() {
          ...
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_normal2$8.$$arity = 0);
        Opal.def(self, '$normal3', $GurpsFW_normal3$11 = function $$normal3() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["特性HPポーション", "特性MPポーション", "黒い甲冑", "天体望遠鏡", "金獅子の剥製", $send(self, 'lambda', [], ($$12 = function (_$$6) {
            function $$12() {
            ...
            return self.$normal4().$to_s();
          }), $$12.$$s = self, $$12.$$arity = 0, $$12))];
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_normal3$11.$$arity = 0);
        Opal.def(self, '$normal4', $GurpsFW_normal4$13 = function $$normal4() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["特性スタミナポーション", "戦乙女の兜", "フェンリルの首輪", "フェニックスカーペット", "動くアダマンゴーレム", $send(self, 'lambda', [], ($$14 = function (_$$7) {
            function $$14() {
            ...
            return self.$normal5().$to_s();
          }), $$14.$$s = self, $$14.$$arity = 0, $$14))];
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_normal4$13.$$arity = 0);
        Opal.def(self, '$normal5', $GurpsFW_normal5$15 = function $$normal5() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["キャンディークッション", "屑鉄の金床", "薪割り王の斧", "ロジエの水差し", "箱舟の模型", $send(self, 'lambda', [], ($$16 = function (_$$8) {
            function $$16() {
            ...
            return self.$premium5().$to_s();
          }), $$16.$$s = self, $$16.$$arity = 0, $$16))];
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_normal5$15.$$arity = 0);
        Opal.def(self, '$premium1', $GurpsFW_premium1$17 = function $$premium1() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["プレミアムチキン", "プレミアムチキン", "プレミアムチキン", $send(self, 'lambda', [], ($$18 = function (_$$9) {
            function $$18() {
            ...
            return self.$normal3().$to_s();
          }), $$18.$$s = self, $$18.$$arity = 0, $$18)), $send(self, 'lambda', [], ($$19 = function (_$$10) {
            function $$19() {
            ...
            return self.$premium2().$to_s();
          }), $$19.$$s = self, $$19.$$arity = 0, $$19)), $send(self, 'lambda', [], ($$20 = function (_$$11) {
            function $$20() {
          ...
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_premium1$17.$$arity = 0);
        Opal.def(self, '$premium2', $GurpsFW_premium2$21 = function $$premium2() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["親衛隊バッジ", "ハタモトチャブダイ", "星のコンパス", "白銀の甲冑", $send(self, 'lambda', [], ($$22 = function (_$$12) {
            function $$22() {
            ...
            return self.$normal4().$to_s();
          }), $$22.$$s = self, $$22.$$arity = 0, $$22)), $send(self, 'lambda', [], ($$23 = function (_$$13) {
            function $$23() {
            ...
            return self.$premium3().$to_s();
          }), $$23.$$s = self, $$23.$$arity = 0, $$23))];
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_premium2$21.$$arity = 0);
        Opal.def(self, '$premium3', $GurpsFW_premium3$24 = function $$premium3() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["特性クイックHPポーション", "特性クイックMPポーション", "特製クイックスタミナポーション", "火龍のフィギュアor氷龍のフィギュア(選択可)", "ヒメショーグンドレス", $send(self, 'lambda', [], ($$25 = function (_$$14) {
            function $$25() {
            ...
            return self.$premium4().$to_s();
          }), $$25.$$s = self, $$25.$$arity = 0, $$25))];
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_premium3$24.$$arity = 0);
        Opal.def(self, '$premium4', $GurpsFW_premium4$26 = function $$premium4() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["クイックユグドラポーション", "銀河龍のフィギュア/ドラゴン", "銀河龍のフィギュア/魔族", "魔族チェスセット", "イグニスコンロ", $send(self, 'lambda', [], ($$27 = function (_$$15) {
            function $$27() {
          ...
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_premium4$26.$$arity = 0);
        Opal.def(self, '$premium5', $GurpsFW_premium5$28 = function $$premium5() {
          var $a,
              $b,
              self = this,
              table = nil,
              result = nil;
          table = ["グレヴディバリウス", "天使の望遠鏡orデスの目覚まし時計(選択可)", "世界樹の蔦", "死神の飾りドレス", "ザバーニヤ等身大フィギュア", $send(self, 'lambda', [], ($$29 = function (_$$16) {
            function $$29() {
            ...
            return self.$premium6().$to_s();
          }), $$29.$$s = self, $$29.$$arity = 0, $$29))];
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_premium5$28.$$arity = 0);
        Opal.def(self, '$premium6', $GurpsFW_premium6$30 = function $$premium6() {
          var $a,
              $b,
              self = this,
              table = nil,
          ...
          $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), result = $a[0] == null ? nil : $a[0], $b;
          return result;
        }, $GurpsFW_premium6$30.$$arity = 0);
        Opal.def(self, '$getLotResult', $GurpsFW_getLotResult$31 = function $$getLotResult(type) {
          var self = this;
        ...
        }, $GurpsFW_getLotResult$31.$$arity = 1);
        Opal.def(self, '$getTresureTable', $GurpsFW_getTresureTable$32 = function $$getTresureTable(num) {
          var self = this,
              $case = nil,
              table = nil;
          $case = num;
          ...
          ;
          return table;
        }, $GurpsFW_getTresureTable$32.$$arity = 1);
        Opal.def(self, '$getTrapTable', $GurpsFW_getTrapTable$33 = function $$getTrapTable(diff) {
          var self = this,
              $case = nil,
              dif = nil,
              d = nil,
          ...
          return [dif, table];
        }, $GurpsFW_getTrapTable$33.$$arity = 1);
        Opal.def(self, '$getRandomEvent', $GurpsFW_getRandomEvent$34 = function $$getRandomEvent(dice1, dice2, diff) {
          var self = this,
              $case = nil,
              dif = nil,
              d = nil,
        ...
        }, $GurpsFW_getRandomEvent$34.$$arity = 3);
        return (Opal.def(self, '$getRandomDiff', $GurpsFW_getRandomDiff$35 = function $$getRandomDiff(dice1, dice23, dif, index) {
          var self = this,
              table = nil,
              $case = nil,
              result = nil;
        ...
        }, $GurpsFW_getRandomDiff$35.$$arity = 4), nil) && 'getRandomDiff';
...
//# sourceMappingURL=default~GurpsFW~index.js.map