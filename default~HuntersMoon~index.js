(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~HuntersMoon~index"],{

/***/ "pLfI":
/*!*******************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/HuntersMoon.js ***!
  \*******************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $HuntersMoon_initialize$1,
            $HuntersMoon_result_2d6$2,
            $HuntersMoon_eval_game_system_specific_command$3,
            $HuntersMoon_roll_strange_ability_table$4;
        ...
        Opal.def(self, '$initialize', $HuntersMoon_initialize$1 = function $$initialize(command) {
          var $iter = $HuntersMoon_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $HuntersMoon_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $HuntersMoon_initialize$1, false, true), 'initialize', [command], null);
          self.sort_add_dice = true;
          self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'ASC');
          return self.round_type = $$$($$($nesting, 'RoundType'), 'CEIL');
        }, $HuntersMoon_initialize$1.$$arity = 1);
        Opal.def(self, '$result_2d6', $HuntersMoon_result_2d6$2 = function $$result_2d6(_total, dice_total, _dice_list, cmp_op, _target) {
          var self = this;
          ...
          if ($truthy($rb_le(dice_total, 2))) {
            return $$($nesting, 'Result').$fumble("ファンブル(モノビースト追加行動+1)");
          } else if ($truthy($rb_ge(dice_total, 12))) {
            return $$($nesting, 'Result').$critical("スペシャル(変調1つ回復orダメージ+1D6)");
          } else {
            return nil;
          }

          ;
        }, $HuntersMoon_result_2d6$2.$$arity = 5);
        Opal.def(self, '$eval_game_system_specific_command', $HuntersMoon_eval_game_system_specific_command$3 = function $$eval_game_system_specific_command(command) {
          var self = this,
              $case = nil,
              $ret_or_1 = nil;
          return function () {
        ...
        }, $HuntersMoon_eval_game_system_specific_command$3.$$arity = 1);
        Opal.def(self, '$roll_strange_ability_table', $HuntersMoon_roll_strange_ability_table$4 = function $$roll_strange_ability_table(command) {
          var $a,
              _$$,
              self = this,
              m = nil,
          ...
          count = function () {
            if ($truthy($ret_or_2 = ($a = m['$[]'](2), $a === nil || $a == null ? nil : $send($a, 'to_i', [])))) {
              return $ret_or_2;
            } else {
              return 1;
            }
          ...
          table = function () {
            if ($truthy(type2)) {
              return $$($nesting, 'StrangeAbilityTable2').$new();
            } else {
              return $$($nesting, 'StrangeAbilityTable1').$new();
            }
          ...
          dice_list = [];
          chosen_list = [];
          $send(count, 'times', [], (_$$ = function $$5() {
            var self = _$$.$$s == null ? this : _$$.$$s;
            if (self.randomizer == null) self.randomizer = nil;
            table.$roll(self.randomizer);
            dice_list['$<<'](table.$dice());
            return chosen_list['$<<'](table.$chosen());
          }, _$$.$$s = self, _$$.$$arity = 0, _$$));
          dice = dice_list.$join(",");
          chosen = chosen_list.$join("/");
          return "" + "異形アビリティー表(" + dice + ") ＞ " + chosen;
        }, $HuntersMoon_roll_strange_ability_table$4.$$arity = 1);

        (function ($base, $super, $parent_nesting) {
          var self = $klass($base, $super, 'StrangeAbilityTable1');
          var $nesting = [self].concat($parent_nesting),
              $StrangeAbilityTable1_roll$6;
          Opal.const_set($nesting[0], 'BODY', ["大牙", "大鎌", "針山", "大鋏", "吸血根", "巨大化", "瘴気", "火炎放射", "鑢", "ドリル", "絶叫", "粘液噴射", "潤滑液", "皮膚装甲", "器官生成", "翼", "四肢複製", "分解", "異言", "閃光", "冷気", "悪臭", "化膿歯", "気嚢", "触手", "肉瘤", "暗視", "邪視", "超振動", "酸分泌", "結晶化", "裏腹", "融合", "嘔吐", "腐敗", "変色"].$freeze());
          self.$attr_reader("dice", "chosen");
          return (Opal.def(self, '$roll', $StrangeAbilityTable1_roll$6 = function $$roll(randomizer) {
            var self = this,
                dice1 = nil,
                dice2 = nil,
                index = nil;
            ...
            return self.chosen = $$($nesting, 'BODY')['$[]'](index);
          }, $StrangeAbilityTable1_roll$6.$$arity = 1), nil) && 'roll';
        })($nesting[0], null, $nesting);

        (function ($base, $super, $parent_nesting) {
          var self = $klass($base, $super, 'StrangeAbilityTable2');
          var $nesting = [self].concat($parent_nesting),
              $StrangeAbilityTable2_roll$7;
          Opal.const_set($nesting[0], 'BODY', ["電撃", "障壁", "追加肢", "破裂球", "死病", "ソナー", "未来視", "寄生体", "再構築", "分身", "大角", "鉄塊", "硬質化", "生命力吸収", "鬼火", "金縛り", "排出口", "金属化", "鋼鱗", "神経接合", "光翼", "環境適応", "消化剤", "プロペラ", "血栓", "骨槍", "回転", "怒髪", "煙幕", "脂肪層", "逆棘", "偽頭", "赤化", "発条", "凶運", "巨砲"].$freeze());
          self.$attr_reader("dice", "chosen");
          return (Opal.def(self, '$roll', $StrangeAbilityTable2_roll$7 = function $$roll(randomizer) {
            var self = this,
                dice = nil,
                table = nil,
                table_id = nil,
            ...
            table = function () {
              if ($truthy(dice['$odd?']())) {
                return $$$($$($nesting, 'StrangeAbilityTable1'), 'BODY');
              } else {
                return $$($nesting, 'BODY');
              }
...
//# sourceMappingURL=default~HuntersMoon~index.js.map