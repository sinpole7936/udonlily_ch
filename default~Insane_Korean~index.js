(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Insane_Korean~index"],{

/***/ "6sQL":
/*!*********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Insane_Korean.js ***!
  \*********************************************************************/
...
Opal.modules["bcdice/game_system/Insane"] = function (Opal) {
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        Opal.def(self, '$initialize', $Insane_Korean_initialize$1 = function $$initialize(command) {
          var $iter = $Insane_Korean_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $Insane_Korean_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $Insane_Korean_initialize$1, false, true), 'initialize', [command], null);
          return self.locale = "ko_kr";
        }, $Insane_Korean_initialize$1.$$arity = 1);
        Opal.const_set($nesting[0], 'TABLES', self.$translate_tables("ko_kr"));
        return Opal.const_set($nesting[0], 'RTT', self.$translate_rtt("ko_kr"));
      })($nesting[0], $$($nesting, 'Insane'), $nesting);
    })($nesting[0], $nesting);
  }($nesting[0], $nesting);
})(Opal);
...
//# sourceMappingURL=default~Insane_Korean~index.js.map