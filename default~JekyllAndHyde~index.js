(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~JekyllAndHyde~index"],{

/***/ "O9Hp":
/*!*********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/JekyllAndHyde.js ***!
  \*********************************************************************/
...
Opal.modules["bcdice/game_system/DesperateRun"] = function (Opal) {
  function $rb_plus(lhs, rhs) {
    return typeof lhs === 'number' && typeof rhs === 'number' ? lhs + rhs : lhs['$+'](rhs);
  }
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $DesperateRun_initialize$1,
            $DesperateRun_eval_game_system_specific_command$2,
            $DesperateRun_check_roll$3,
            $DesperateRun_ddc_table$4;
        self.$$prototype.randomizer = nil;
        Opal.const_set($nesting[0], 'ID', "DesperateRun");
        Opal.const_set($nesting[0], 'NAME', "Desperate Run TRPG");
        Opal.const_set($nesting[0], 'SORT_KEY', "てすへれいとらんTRPG");
        Opal.const_set($nesting[0], 'HELP_MESSAGE', "" + "・難易度算出コマンド　DDC\n" + "・判定コマンド　RCx　or　RCx+y　or　RCx-y（x＝難易度、y=修正値（省略可能））\n" + "・アクシデント表　ACT\n" + "・初期アイテム表　ITEMT\n" + "・動機表　DOUKIT\n" + "・死亡フラグ台詞表　FLAGT\n" + "・途中参加動機表　ENTRYT\n" + "・途中参加道中表　ROADT\n");
        Opal.const_set($nesting[0], 'TABLES', $hash2(["ACT", "ITEMT", "DOUKIT", "FLAGT", "ENTRYT", "ROADT"], {
          "ACT": $$$($$($nesting, 'DiceTable'), 'Table').$new("アクシデント表", "1D6", ["PC全員、隊列を1D6で決める（12：前列、34：中列、56：後列）", "1ターン、モンスター側のみ行動する。", "この戦闘の行動順が、PC→モンスター、から、モンスター→PCに変わる。", "PC全員、アイテム1つを選んで失う。", "PC全員1D6を振る。この戦闘中、その出目はノープランになる。", "PC全員、Flagが1増加する。"]),
          "ITEMT": $$$($$($nesting, 'DiceTable'), 'Table').$new("初期アイテム表", "2D6", ["ロケットランチャー　効果：（装備）マカブルLv+3　回数：攻撃1回", "キーピック　効果：（消費）ムーブシーンで使用可。判定の出目の合計+1　回数：2回", "レーダー　効果：（装備）ノープラン　装備時、「危険」を1減らすことが出来る　回数：危険減少2回", "食料　効果：（消費）ムーブシーンで使用可。Life3回復　回数：1回", "応急キット　効果：（装備）メディカルLv+1　回数：回復3回", "刃物　効果：（装備）アタックLv+1　回数：攻撃6回", "銃　効果：（装備）シュートLv+1　回数：攻撃6回", "ドラッグ　効果：（消費）いつでも使用可。Brave1回復　回数：1回", "金券　効果：（消費）アフタープレイで使用可。経験点+2　回数：1回", "プロテクター　効果：（装備）ガードLv+1　回数：防御5回", "トミーガン　効果：（装備）チェーンLv+5　回数：攻撃1回"]),
          "DOUKIT": $$$($$($nesting, 'DiceTable'), 'Table').$new("動機表", "1D6", ["隷属。何か弱みに付け込まれ、嫌々ながらも参加することとなる。後ろめたい事、借金、など。", "献身。この番組は誰かのために出ている。病気の家族を救うため、参加者の一人が恋人である、など。", "成行。望んでいないのに参加することとなってしまった。誰かが勝手に申し込んだ、紛れ込んでしまった、など。", "渇望。とにかく何かを欲して参加している。金、スリル、金で手に入るもの、など。", "奇人。好き好んでこの番組に出ている。殺人癖、ナルシスト、自殺願望、化け物マニア、など。", "仕事。この番組に出るのは仕事だからだ。賞金稼ぎ、芸能人、記者、番組スタッフ、など。"]),
          "FLAGT": $$$($$($nesting, 'DiceTable'), 'Table').$new("死亡フラグ台詞表", "1D6", ["希望。「これが終わったら、一緒に酒でも飲もうや」「もう何も怖くない」など。", "望郷。「くそっ、、、俺には、帰りを待つ人が、、、っ！」「ああ、故郷のマルゲリータをもう一度食べたかった、、、」など。", "狂乱。「お前を、殺せば、俺は、億万長者なんだよぉぉぉお！！」「ヒハッ、死ね死ね死ね死ねぇぇぇぇ」など。", "絶望。「もうだめだぁ、、、おしまいだぁ、、、」「く、くるなっ、くるなぁぁぁぁ！！」など。", "慢心。「なんだ、こんなやつ、俺だけで十分だ」「大丈夫だ、問題ない」など。", "犠牲。「ふふ、俺なら大丈夫だ、、、気にするな」「お前ら下がれっ！ここは俺に任せろ！」など。"]),
          "ENTRYT": $$$($$($nesting, 'DiceTable'), 'Table').$new("途中参加動機表", "1D6", ["遅刻。もともと参加する予定だったのだが遅れてしまった。今からでも走れと無理矢理参加。", "現住。もともとここに住んでいた。何？番組？え？あ、お金もらえんの？イイネ！", "突発。もともと視聴者としてスタジオに居たんだけど、司会にうまく乗せられて・・・", "乱入。何か目的があって乱入した。今回のステージが簡単に見えたり、参加者に大事な人がいたのかもしれない。", "神隠。今回より前の番組に参加していたが行方不明・死んだと思われていた。が。君はまだここにいる。", "職員。あれ、逃げ遅れました？あらあら、大変ですね、しょうがないから参加者さんと一緒に走ってください。"]),
          "ROADT": $$$($$($nesting, 'DiceTable'), 'Table').$new("途中参加道中表", "1D6", ["死線。死ぬかと思った。Flag+1", "怪我。痛い。Life-1", "失意。どうしてこうなった。Brave-1。減らせない場合、Flag+1", "紛失。どっかいった。Itemをどれか1つ捨てる。捨てれない場合、Flag+1", "追尾。後ろ！後ろーっ！参加開始部屋の危険+1", "迷子。あれ、ここどこだ？途中参加道中表を振る回数+2"])
        }).$freeze());
        self.$register_prefix("RC", "DDC", $$($nesting, 'TABLES').$keys());
        Opal.def(self, '$initialize', $DesperateRun_initialize$1 = function $$initialize(command) {
          var $iter = $DesperateRun_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $DesperateRun_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $DesperateRun_initialize$1, false, true), 'initialize', [command], null);
          self.sort_add_dice = true;
          return self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'ASC');
        }, $DesperateRun_initialize$1.$$arity = 1);
        self.$private();
        Opal.def(self, '$eval_game_system_specific_command', $DesperateRun_eval_game_system_specific_command$2 = function $$eval_game_system_specific_command(command) {
          var self = this,
              $ret_or_1 = nil,
              $ret_or_2 = nil;

          if ($truthy($ret_or_1 = function () {
            if ($truthy($ret_or_2 = self.$check_roll(command))) {
              return $ret_or_2;
            } else {
              return self.$ddc_table(command);
            }
        ...
        }, $DesperateRun_eval_game_system_specific_command$2.$$arity = 1);
        Opal.def(self, '$check_roll', $DesperateRun_check_roll$3 = function $$check_roll(string) {
          var $a,
              $b,
              self = this,
              parser = nil,
              ...
              sequence = nil,
              $writer = nil;
          parser = $$$($$($nesting, 'Command'), 'Parser').$new(/RC\d+/, $hash2(["round_type"], {
          ...
          ;
          $b = self.randomizer.$roll_barabara(2, 6), $a = Opal.to_ary($b), d1 = $a[0] == null ? nil : $a[0], d2 = $a[1] == null ? nil : $a[1], $b;
          dice_total = $rb_plus(d1, d2);
          total = $rb_plus($rb_plus(d1, d2), cmd.$modify_number());
          target = cmd.$command()['$[]']($range(2, -1, false)).$to_i();

          if ($truthy(cmd.$modify_number()['$!='](0))) {
          ...
          result = function () {
            if (d1['$=='](d2)) {
              return $$($nesting, 'Result').$critical("ゾロ目！【Critical】");
            } else if (dice_total['$=='](7)) {
              return $$($nesting, 'Result').$fumble("ダイスの出目が表裏！【Fumble】");
            } else if ($truthy($rb_ge(total, target))) {
              return $$($nesting, 'Result').$success("" + total + "、難易度以上！【Success】");
            } else {
              return $$($nesting, 'Result').$failure("" + total + "、難易度未満！【Miss】");
            }
          ...
          ;
          return result;
        }, $DesperateRun_check_roll$3.$$arity = 1);
        return (Opal.def(self, '$ddc_table', $DesperateRun_ddc_table$4 = function $$ddc_table(command) {
          var $a,
              $b,
              self = this,
              d1 = nil,
          ...
          if ($truthy(command['$!=']("DDC"))) {
            return nil;
          }

          ;
          $b = self.randomizer.$roll_barabara(2, 6), $a = Opal.to_ary($b), d1 = $a[0] == null ? nil : $a[0], d2 = $a[1] == null ? nil : $a[1], $b;
          $b = [d1, d2].$sort(), $a = Opal.to_ary($b), smaller = $a[0] == null ? nil : $a[0], larger = $a[1] == null ? nil : $a[1], $b;
          difference = $rb_minus(larger, smaller);
          return "" + "難易度決定 ＞ 出目：" + d1 + "、" + d2 + " ＞ " + larger + "-" + smaller + "=" + difference + " ＞ 難易度" + $rb_plus(5, difference);
        }, $DesperateRun_ddc_table$4.$$arity = 1), nil) && 'ddc_table';
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting);
        Opal.const_set($nesting[0], 'ID', "JekyllAndHyde");
        Opal.const_set($nesting[0], 'NAME', "ジキルとハイドとグリトグラ");
        Opal.const_set($nesting[0], 'SORT_KEY', "しきるとはいととくりとくら");
        Opal.const_set($nesting[0], 'HELP_MESSAGE', "" + "・難易度算出コマンド　DDC\n" + "・判定コマンド　RCx　or　RCx+y　or　RCx-y（x＝難易度、y=修正値（省略可能））\n" + "・目標決定表　GOALT\n");
        Opal.const_set($nesting[0], 'TABLES', $hash2(["GOALT"], {
          "GOALT": $$$($$($nesting, 'DiceTable'), 'Table').$new("目標決定表", "1D6", ["「主人格の目的達成」", "「主人格の目的阻害」", "「主人格のハッピーエンド（目的達成しなくてもよい）」", "「主人格のバッドエンド（目的達成していてもよい）」", "「自分の人格が目的を決定できる」", "「主人格の目的達成」「主人格の目的阻害」「主人格のハッピーエンド（目的達成しなくてもよい）」「主人格のバッドエンド（目的達成していてもよい）」「自分の人格が目的を決定できる」のどれかを自由に選べる"])
        }).$freeze());
        return self.$register_prefix("RC", "DDC", $$($nesting, 'TABLES').$keys());
      })($nesting[0], $$($nesting, 'DesperateRun'), $nesting);
    })($nesting[0], $nesting);
  }($nesting[0], $nesting);
})(Opal);
...
//# sourceMappingURL=default~JekyllAndHyde~index.js.map