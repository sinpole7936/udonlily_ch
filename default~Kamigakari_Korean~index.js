(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Kamigakari_Korean~index"],{

/***/ "VABX":
/*!*************************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Kamigakari_Korean.js ***!
  \*************************************************************************/
...
Opal.modules["bcdice/game_system/Kamigakari"] = function (Opal) {
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $Kamigakari_Korean_initialize$1;
        ...
        Opal.def(self, '$initialize', $Kamigakari_Korean_initialize$1 = function $$initialize(command) {
          var $iter = $Kamigakari_Korean_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $Kamigakari_Korean_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $Kamigakari_Korean_initialize$1, false, true), 'initialize', [command], null);
          return self.locale = "ko_kr";
        }, $Kamigakari_Korean_initialize$1.$$arity = 1);
        return Opal.const_set($nesting[0], 'TABLES', self.$translate_tables("ko_kr").$freeze());
      })($nesting[0], $$($nesting, 'Kamigakari'), $nesting);
    })($nesting[0], $nesting);
  }($nesting[0], $nesting);
})(Opal);
...
//# sourceMappingURL=default~Kamigakari_Korean~index.js.map