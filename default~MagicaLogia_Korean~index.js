(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~MagicaLogia_Korean~index"],{

/***/ "XRby":
/*!**************************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/MagicaLogia_Korean.js ***!
  \**************************************************************************/
...
Opal.modules["bcdice/game_system/MagicaLogia"] = function (Opal) {
  function $rb_le(lhs, rhs) {
    return typeof lhs === 'number' && typeof rhs === 'number' ? lhs <= rhs : lhs['$<='](rhs);
  }
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $MagicaLogia_initialize$1,
            $MagicaLogia_result_2d6$2,
            $MagicaLogia_eval_game_system_specific_command$3,
            $MagicaLogia_gain_magic_element$4;
        ...
        Opal.def(self, '$initialize', $MagicaLogia_initialize$1 = function $$initialize(command) {
          var $iter = $MagicaLogia_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
        ...
        Opal.def(self, '$gain_magic_element', $MagicaLogia_gain_magic_element$4 = function $$gain_magic_element(dice1, dice2) {
          ...
          return $rb_plus(" ＞ ", self.$format(self.$translate("MagicaLogia.elements.format"), $hash2(["text"], {
            "text": element
          })));
        ...
        (function ($base, $super, $parent_nesting) {
          ...
          var $nesting = [self].concat($parent_nesting),
              $SkillExpandTable_from_i18n$5,
              $SkillExpandTable_initialize$6,
              $SkillExpandTable_roll$7,
              $SkillExpandTable_expand$8,
              $SkillExpandTable_roll_skill$10;
          ...
          Opal.def(self, '$expand', $SkillExpandTable_expand$8 = function $$expand(chosen, randomizer) {
            ...
            return $send(chosen, 'gsub', [/%{([a-z]+)}/], (_$$36 = function $$9() {
              var self = _$$36.$$s == null ? this : _$$36.$$s,
                  m = nil,
                  type = nil;
              m = $$($nesting, 'Regexp').$last_match();
              type = m['$[]'](1).$to_sym();
              return self.$roll_skill(type, randomizer);
            }, _$$36.$$s = self, _$$36.$$arity = 0, _$$36));
        ...
        (function ($base, $super, $parent_nesting) {
          ...
          var $nesting = [self].concat($parent_nesting),
              $FallenAfterTable_from_i18n$11,
              $FallenAfterTable_initialize$12,
              $FallenAfterTable_roll$13;
        ...
        (function (self, $parent_nesting) {
          var $nesting = [self].concat($parent_nesting),
              $translate_skill_table$14,
              $translate_tables$15;
          self.$private();
          Opal.def(self, '$translate_skill_table', $translate_skill_table$14 = function $$translate_skill_table(locale) {
            var self = this;
            return $$$($$($nesting, 'DiceTable'), 'SaiFicSkillTable').$from_i18n("MagicaLogia.skill_table", locale, $hash2(["rttn"], {
          ...
          return (Opal.def(self, '$translate_tables', $translate_tables$15 = function $$translate_tables(locale, skill_table) {
            var self = this,
                inveterate_enemy_table = nil,
                conspiracy_table = nil,
                fate_table = nil,
                cueball_table = nil,
                force_field_table = nil,
                alliance_table = nil;
            ...
            return $hash2(["TPT", "ST", "FT", "WT", "FCT", "AT", "BGT", "DAT", "FAT", "WIT", "TCT", "PCT", "MCT", "ICT", "SCT", "XCT", "WCT", "CCT", "MIT", "MOT", "MAT", "MUT", "MFT", "MLT", "BST", "PT", "XEST", "IWST", "MCST", "WDST", "LWST", "STB", "MGCT", "MBST", "MAST", "TCST", "PWST", "PAST", "GBST", "SLST", "WLAT", "WMT", "FFT", "OLST", "TPTB", "FLT"], {
              "TPT": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.TPT", locale, skill_table),
              "ST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.ST", locale, skill_table),
              "FT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.FT", locale),
              "WT": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.WT", locale, skill_table),
              "FCT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.FCT", locale),
              "AT": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.AT", locale, skill_table),
              "BGT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.BGT", locale),
              "DAT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.DAT", locale),
              "FAT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.FAT", locale),
              "WIT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.WIT", locale),
              "TCT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.TCT", locale),
              "PCT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.PCT", locale),
              "MCT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.MCT", locale),
              "ICT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.ICT", locale),
              "SCT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.SCT", locale),
              "XCT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.XCT", locale),
              "WCT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.WCT", locale),
              "CCT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.CCT", locale),
              ...
              "MLT": alliance_table,
              "BST": $$$($$($nesting, 'DiceTable'), 'ChainTable').$new($$($nesting, 'I18n').$translate("MagicaLogia.tables.BST.name", $hash2(["raise", "locale"], {
                "raise": true,
                "locale": locale
              })), "1D6", [inveterate_enemy_table, conspiracy_table, fate_table, cueball_table, force_field_table, alliance_table]),
              "PT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.PT", locale),
              "XEST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.XEST", locale, skill_table),
              "IWST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.IWST", locale, skill_table),
              "MCST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.MCST", locale, skill_table),
              "WDST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.WDST", locale, skill_table),
              "LWST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.LWST", locale, skill_table),
              "STB": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.STB", locale, skill_table),
              "MGCT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.MGCT", locale),
              "MBST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.MBST", locale, skill_table),
              "MAST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.MAST", locale, skill_table),
              "TCST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.TCST", locale, skill_table),
              "PWST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.PWST", locale, skill_table),
              "PAST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.PAST", locale, skill_table),
              "GBST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.GBST", locale, skill_table),
              "SLST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.SLST", locale, skill_table),
              "WLAT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.WLAT", locale),
              "WMT": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.WMT", locale, skill_table),
              "FFT": $$$($$($nesting, 'DiceTable'), 'Table').$from_i18n("MagicaLogia.tables.FFT", locale),
              "OLST": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.OLST", locale, skill_table),
              "TPTB": $$($nesting, 'SkillExpandTable').$from_i18n("MagicaLogia.tables.TPTB", locale, skill_table),
              "FLT": $$($nesting, 'FallenAfterTable').$from_i18n("MagicaLogia.tables.FLT", locale)
            });
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $MagicaLogia_Korean_initialize$1;
        Opal.const_set($nesting[0], 'ID', "MagicaLogia:Korean");
        Opal.const_set($nesting[0], 'NAME', "마기카로기아");
        Opal.const_set($nesting[0], 'SORT_KEY', "国際化:Korean:마기카로기아");
        ...
        Opal.def(self, '$initialize', $MagicaLogia_Korean_initialize$1 = function $$initialize(command) {
          var $iter = $MagicaLogia_Korean_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $MagicaLogia_Korean_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $MagicaLogia_Korean_initialize$1, false, true), 'initialize', [command], null);
          return self.locale = "ko_kr";
        }, $MagicaLogia_Korean_initialize$1.$$arity = 1);
        Opal.const_set($nesting[0], 'SKILL_TABLE', self.$translate_skill_table("ko_kr"));
        return Opal.const_set($nesting[0], 'TABLES', self.$translate_tables("ko_kr", $$($nesting, 'SKILL_TABLE')));
      })($nesting[0], $$($nesting, 'MagicaLogia'), $nesting);
    })($nesting[0], $nesting);
  }($nesting[0], $nesting);
})(Opal);
...
//# sourceMappingURL=default~MagicaLogia_Korean~index.js.map