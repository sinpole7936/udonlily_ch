(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~MeikyuDays~index"],{

/***/ "5Ur+":
/*!******************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/MeikyuDays.js ***!
  \******************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $MeikyuDays_initialize$1,
            $MeikyuDays_replace_text$2,
            $MeikyuDays_result_2d6$5,
            $MeikyuDays_checkRoll$6,
            $MeikyuDays_eval_game_system_specific_command$7;
        ...
        Opal.def(self, '$initialize', $MeikyuDays_initialize$1 = function $$initialize(command) {
          var $iter = $MeikyuDays_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $MeikyuDays_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $MeikyuDays_initialize$1, false, true), 'initialize', [command], null);
          self.sort_add_dice = true;
          return self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'ASC');
        }, $MeikyuDays_initialize$1.$$arity = 1);
        Opal.def(self, '$replace_text', $MeikyuDays_replace_text$2 = function $$replace_text(string) {
          var _$$,
              _$$2,
              self = this;

          string = $send(string, 'gsub', [/(\d+)MD6/i], (_$$ = function $$3() {
            var self = _$$.$$s == null ? this : _$$.$$s;
            return "" + $$($nesting, 'Regexp').$last_match(1) + "R6";
          }, _$$.$$s = self, _$$.$$arity = 0, _$$));
          string = $send(string, 'gsub', [/(\d+)MD/i], (_$$2 = function $$4() {
            var self = _$$2.$$s == null ? this : _$$2.$$s;
            return "" + $$($nesting, 'Regexp').$last_match(1) + "R6";
          }, _$$2.$$s = self, _$$2.$$arity = 0, _$$2));
          return string;
        }, $MeikyuDays_replace_text$2.$$arity = 1);
        Opal.def(self, '$result_2d6', $MeikyuDays_result_2d6$5 = function $$result_2d6(total, dice_total, _dice_list, cmp_op, target) {
          var self = this;
          ...
          ;
        }, $MeikyuDays_result_2d6$5.$$arity = 5);
        Opal.def(self, '$checkRoll', $MeikyuDays_checkRoll$6 = function $$checkRoll(string) {
          var self = this,
              m = nil,
              dice_c = nil,
              bonus = nil,
          ...
          if ($truthy(m = /(^|\s)S?((\d+)[rR]6([+\-\d]*)(([>=]+)(\d+))?)(\s|$)/i.$match(string))) {} else {
          ...
          if ($truthy(bonusText['$nil?']())) {} else {
            bonus = $$($nesting, 'ArithmeticEvaluator').$eval(bonusText);
          }
...
//# sourceMappingURL=default~MeikyuDays~index.js.map