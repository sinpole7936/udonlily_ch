(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~MetalHeadExtream~index"],{

/***/ "isKR":
/*!************************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/MetalHeadExtream.js ***!
  \************************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $MetalHeadExtream_eval_game_system_specific_command$1,
            $MetalHeadExtream_checkRoll$3,
            $MetalHeadExtream_get_roll_parameter$4,
            $MetalHeadExtream_getRollResultTextAndSuccesValue$5,
            $MetalHeadExtream_getFormulaText$6,
            $MetalHeadExtream_get_hit_table$7,
            $MetalHeadExtream_get_SUV_table$8,
            $MetalHeadExtream_get_damageEffect_table$10,
            $MetalHeadExtream_get_critical_table$12,
            $MetalHeadExtream_get_accident_table$13,
            $MetalHeadExtream_get_mechanicAccident_table$14,
            $MetalHeadExtream_get_strategyEvent_chart$15,
            $MetalHeadExtream_get_NPCAttack_chart$16,
            $MetalHeadExtream_get_loserDestiny_chart$17,
            $MetalHeadExtream_get_randomEncounter_table$18,
            $MetalHeadExtream_get_MetalHeadExtream_1d10_table_result$19,
            $MetalHeadExtream_get_MetalHeadExtream_1d100_table_result$20,
            $MetalHeadExtream_get_MetalHeadExtream_1dX_table_result$21,
            $MetalHeadExtream_get_roc_dice$22,
            $MetalHeadExtream_get_value$23;
        ...
        Opal.def(self, '$eval_game_system_specific_command', $MetalHeadExtream_eval_game_system_specific_command$1 = function $$eval_game_system_specific_command(command) {
          ...
          text = function () {
            ...
            if (/([AS])R(\d+)(([*\/]\d+)*)?(((@|A|L)\d+)*)(!M)?$/i['$===']($case)) {
              ...
              $send(params, 'each', [], (_$$ = function $$2(marker, value) {
                ...
                ;
                return $b = self.$get_roll_parameter(accidentValue, advancedRoll, luckPoint, marker, value), $a = Opal.to_ary($b), accidentValue = $a[0] == null ? nil : $a[0], advancedRoll = $a[1] == null ? nil : $a[1], luckPoint = $a[2] == null ? nil : $a[2], $b;
              ...
              roc = function () {
                if ($truthy($ret_or_3 = $$($nesting, 'Regexp').$last_match(1))) {
                  return $ret_or_3;
                } else {
                  return 0;
                }
              ...
              return self.$get_strategyEvent_chart();
            } else if ("NAC"['$===']($case)) {
              return self.$get_NPCAttack_chart();
            } else if ("LDC"['$===']($case)) {
              return self.$get_loserDestiny_chart();
            } else if (/(W)ENC(\d+)?/i['$===']($case)) {
              locationType = $$($nesting, 'Regexp').$last_match(1);

              roc = function () {
                if ($truthy($ret_or_7 = $$($nesting, 'Regexp').$last_match(2))) {
                  return $ret_or_7;
                } else {
                  return 0;
                }
        ...
        Opal.def(self, '$get_SUV_table', $MetalHeadExtream_get_SUV_table$8 = function $$get_SUV_table(armorGrade, damage) {
          ...
          (function () {
            ...
            try {
              return $send(damageInfo, 'each_with_index', [], (_$$2 = function $$9(rate, index) {
                ...
                ;
                return woundText = woundRanks['$[]'](index);
              }, _$$2.$$s = self, _$$2.$$brk = $brk, _$$2.$$arity = 2, _$$2));
            } catch (err) {
              if (err === $brk) {
                return err.$v;
              } else {
        ...
        Opal.def(self, '$get_damageEffect_table', $MetalHeadExtream_get_damageEffect_table$10 = function $$get_damageEffect_table(hitPart, damageStage) {
          ...
          index = $send(damageInfos, 'index', [], (_$$3 = function $$11(i) {
        ...
        return (Opal.def(self, '$get_value', $MetalHeadExtream_get_value$23 = function $$get_value(originalValue, calculateText) {
          ...
          calculateArray = function () {
            if ($truthy($ret_or_8 = calculateText)) {
              return $ret_or_8;
            } else {
              return "";
            }
          ...
          $send(calculateArray, 'each', [], (_$$4 = function $$24(i) {
...
//# sourceMappingURL=default~MetalHeadExtream~index.js.map