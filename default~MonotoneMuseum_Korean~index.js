(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~MonotoneMuseum_Korean~index"],{

/***/ "0ddw":
/*!*****************************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/MonotoneMuseum_Korean.js ***!
  \*****************************************************************************/
...
Opal.modules["bcdice/game_system/MonotoneMuseum"] = function (Opal) {
  function $rb_plus(lhs, rhs) {
    return typeof lhs === 'number' && typeof rhs === 'number' ? lhs + rhs : lhs['$+'](rhs);
  }
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $MonotoneMuseum_Korean_initialize$1;
        ...
        Opal.def(self, '$initialize', $MonotoneMuseum_Korean_initialize$1 = function $$initialize(command) {
          var $iter = $MonotoneMuseum_Korean_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $MonotoneMuseum_Korean_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $MonotoneMuseum_Korean_initialize$1, false, true), 'initialize', [command], null);
          return self.locale = "ko_kr";
        }, $MonotoneMuseum_Korean_initialize$1.$$arity = 1);
        return Opal.const_set($nesting[0], 'TABLES', self.$translate_tables("ko_kr").$freeze());
      })($nesting[0], $$($nesting, 'MonotoneMuseum'), $nesting);
    })($nesting[0], $nesting);
  }($nesting[0], $nesting);
})(Opal);
...
//# sourceMappingURL=default~MonotoneMuseum_Korean~index.js.map