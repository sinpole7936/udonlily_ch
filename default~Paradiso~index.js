(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Paradiso~index"],{

/***/ "xjZ9":
/*!****************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Paradiso.js ***!
  \****************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $Paradiso_eval_game_system_specific_command$1,
            $Paradiso_getJudgeResult$2,
            $Paradiso_getDamageResult$4,
            $Paradiso_get_radiomarietta_table$7,
            $Paradiso_get_takeoff_table$8,
            $Paradiso_get_exploration_table$9,
            $Paradiso_get_flightsupply_table$10;
        ...
        Opal.def(self, '$eval_game_system_specific_command', $Paradiso_eval_game_system_specific_command$1 = function $$eval_game_system_specific_command(command) {
          var self = this,
              result = nil,
              $case = nil;
          ...
          ;
        }, $Paradiso_eval_game_system_specific_command$1.$$arity = 1);
        Opal.def(self, '$getJudgeResult', $Paradiso_getJudgeResult$2 = function $$getJudgeResult(command) {
          ...
          if (/^(\d+)?D20<=(\d+)?(\[(\d+)(,(\d+))?\])?(@(\d+))?$/i['$===']($case)) {
            ...
            fumble1 = function () {
              if ($truthy($ret_or_3 = $$($nesting, 'Regexp').$last_match(4))) {
                return $ret_or_3;
              } else {
                return 21;
              }
            ...
            critical = function () {
              if ($truthy($ret_or_5 = $$($nesting, 'Regexp').$last_match(8))) {
                return $ret_or_5;
              } else {
                return 21;
              }
            ...
            number = function () {
              if ($truthy($ret_or_6 = $$($nesting, 'Regexp').$last_match(1))) {
                return $ret_or_6;
              } else {
                return 1;
              }
            ...
            fumble1 = function () {
              if ($truthy($ret_or_8 = $$($nesting, 'Regexp').$last_match(4))) {
                return $ret_or_8;
              } else {
                return 21;
              }
            ...
            fumble2 = function () {
              if ($truthy($ret_or_9 = $$($nesting, 'Regexp').$last_match(6))) {
                return $ret_or_9;
              } else {
                return 21;
              }
            ...
            critical = function () {
              if ($truthy($ret_or_10 = $$($nesting, 'Regexp').$last_match(8))) {
                return $ret_or_10;
              } else {
                return 21;
              }
        ...
        Opal.def(self, '$getDamageResult', $Paradiso_getDamageResult$4 = function $$getDamageResult(command) {
          ...
          if (/^DC(\d+)(\[(\d+)(,(\d+))?(,(\d+))?(,(\d+))?(,(\d+))?(,(\d+))?\])?$/i['$===']($case)) {
            attack = function () {
              if ($truthy($ret_or_11 = $$($nesting, 'Regexp').$last_match(1))) {
                return $ret_or_11;
              } else {
                return 1;
              }
            ...
            $writer = [0, function () {
              if ($truthy($ret_or_12 = $$($nesting, 'Regexp').$last_match(3))) {
                return $ret_or_12;
              } else {
                return 0;
              }
            ...
            ;
            $writer = [1, function () {
              if ($truthy($ret_or_13 = $$($nesting, 'Regexp').$last_match(5))) {
                return $ret_or_13;
              } else {
                return 0;
              }
            ...
            ;
            $writer = [2, function () {
              if ($truthy($ret_or_14 = $$($nesting, 'Regexp').$last_match(7))) {
                return $ret_or_14;
              } else {
                return 0;
              }
            ...
            ;
            $writer = [3, function () {
              if ($truthy($ret_or_15 = $$($nesting, 'Regexp').$last_match(9))) {
                return $ret_or_15;
              } else {
                return 0;
              }
            ...
            ;
            $writer = [4, function () {
              if ($truthy($ret_or_16 = $$($nesting, 'Regexp').$last_match(11))) {
                return $ret_or_16;
              } else {
                return 0;
              }
            ...
            ;
            $writer = [5, function () {
              if ($truthy($ret_or_17 = $$($nesting, 'Regexp').$last_match(13))) {
                return $ret_or_17;
              } else {
                return 0;
              }
          ...
          doubledam = 0;
          tripledam = 0;
          $send(biggun, 'each', [], (_$$2 = function $$5(bg) {
          ...
          $send(attack, 'times', [], (_$$3 = function $$6() {
        ...
        Opal.def(self, '$get_exploration_table', $Paradiso_get_exploration_table$9 = function $$get_exploration_table() {
          ...
          } else if ($range(10, 13, false)['$===']($case)) {
...
//# sourceMappingURL=default~Paradiso~index.js.map