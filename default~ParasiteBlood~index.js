(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~ParasiteBlood~index"],{

/***/ "xRit":
/*!*********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/ParasiteBlood.js ***!
  \*********************************************************************/
...
Opal.modules["bcdice/game_system/DemonParasite"] = function (Opal) {
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $DemonParasite_initialize$1,
            $DemonParasite_result_nd6$2,
            $DemonParasite_eval_game_system_specific_command$3,
            $DemonParasite_get_urge$4;
        ...
        Opal.def(self, '$initialize', $DemonParasite_initialize$1 = function $$initialize(command) {
          var $iter = $DemonParasite_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $DemonParasite_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $DemonParasite_initialize$1, false, true), 'initialize', [command], null);
          self.sort_add_dice = true;
          return self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'NO_SORT');
        }, $DemonParasite_initialize$1.$$arity = 1);
        Opal.def(self, '$result_nd6', $DemonParasite_result_nd6$2 = function $$result_nd6(_total, _dice_total, dice_list, _cmp_op, target) {
          var self = this;

          if ($truthy($rb_ge(dice_list.$count(1), 2))) {
            return $$($nesting, 'Result').$fumble("致命的失敗");
          } else if ($truthy($rb_ge(dice_list.$count(6), 2))) {
            return $$($nesting, 'Result').$critical("効果的成功");
          } else if (target['$==']("?")) {
            return $$($nesting, 'Result').$nothing();
          } else {
            return nil;
          }
        }, $DemonParasite_result_nd6$2.$$arity = 5);
        Opal.def(self, '$eval_game_system_specific_command', $DemonParasite_eval_game_system_specific_command$3 = function $$eval_game_system_specific_command(command) {
          var self = this;
          return self.$get_urge(command);
        }, $DemonParasite_eval_game_system_specific_command$3.$$arity = 1);
        Opal.def(self, '$get_urge', $DemonParasite_get_urge$4 = function $$get_urge(string) {
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_1 = $rb_lt(urgelv, 1))) {
              return $ret_or_1;
            } else {
              return $rb_gt(urgelv, 5);
            }
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $ParasiteBlood_get_urge$1,
            $ParasiteBlood_get_pb_urge_table$2,
            $ParasiteBlood_get_pb_normal_urge_table$3,
            $ParasiteBlood_get_pb_aas_urge_table$4;
        self.$$prototype.randomizer = nil;
        ...
        Opal.def(self, '$get_urge', $ParasiteBlood_get_urge$1 = function $$get_urge(string) {
          ...
          if ($truthy(/(\w*)URGE\s*(\d+)/i['$=~'](string))) {} else {
            return "1";
          }
...
//# sourceMappingURL=default~ParasiteBlood~index.js.map