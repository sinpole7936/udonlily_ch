(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Peekaboo~index"],{

/***/ "bgGC":
/*!****************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Peekaboo.js ***!
  \****************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $Peekaboo_initialize$1,
            $Peekaboo_result_2d6$2,
            $Peekaboo_eval_game_system_specific_command$3;
        ...
        Opal.def(self, '$initialize', $Peekaboo_initialize$1 = function $$initialize(command) {
          var $iter = $Peekaboo_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $Peekaboo_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $Peekaboo_initialize$1, false, true), 'initialize', [command], null);
          self.sort_add_dice = true;
          self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'ASC');
          return self.round_type = $$$($$($nesting, 'RoundType'), 'CEIL');
        }, $Peekaboo_initialize$1.$$arity = 1);
        Opal.def(self, '$result_2d6', $Peekaboo_result_2d6$2 = function $$result_2d6(_total, dice_total, _dice_list, cmp_op, _target) {
          var self = this;
          ...
          if ($truthy($rb_le(dice_total, 2))) {
            return $$($nesting, 'Result').$fumble("ファンブル(【眠気】が1d6点上昇)");
          } else if ($truthy($rb_ge(dice_total, 12))) {
            return $$($nesting, 'Result').$critical("スペシャル(【魔力】あるいは【眠気】が1d6点回復)");
          } else {
            return nil;
          }

          ;
        }, $Peekaboo_result_2d6$2.$$arity = 5);
        Opal.def(self, '$eval_game_system_specific_command', $Peekaboo_eval_game_system_specific_command$3 = function $$eval_game_system_specific_command(command) {
          var self = this,
              $ret_or_1 = nil;
        ...
        }, $Peekaboo_eval_game_system_specific_command$3.$$arity = 1);
        Opal.const_set($nesting[0], 'RTT', $$$($$($nesting, 'DiceTable'), 'SaiFicSkillTable').$new([["不良", ["夜更かし", "いねむり", "無視", "ウソつき", "悪口", "いたずら", "ズル", "隠れる", "ぬすむ", "おどす", "けんか"]], ["運動", ["泳ぐ", "木登り", "柔らかい", "マラソン", "とぶ", "かけっこ", "バランス", "投げる", "球技", "打ち返す", "力持ち"]], ["友達", ["ネット", "うわさ話", "優しさ", "がまん", "お手紙", "おしゃべり", "自転車", "勇気", "約束", "仕切る", "秘密基地"]], ["遊び", ["パソコン", "ゲーム", "集める", "絵", "音楽", "空想", "読書", "お話づくり", "クイズ", "手品", "占い"]], ["勉強", ["実験", "宇宙", "生き物", "工作", "計算", "宿題", "漢字", "作文", "歴史", "地理", "外国語"]], ["大人", ["法律", "しかる", "手当て", "マナー", "推理", "計画性", "お料理", "お買い物", "オシャレ", "恋愛", "道楽"]]], $hash2(["rttn", "rtt_format", "rttn_format"], {
...
//# sourceMappingURL=default~Peekaboo~index.js.map