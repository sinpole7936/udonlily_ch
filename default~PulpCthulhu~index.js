(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~PulpCthulhu~index"],{

/***/ "cunF":
/*!*******************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/PulpCthulhu.js ***!
  \*******************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $PulpCthulhu_eval_game_system_specific_command$1,
            $PulpCthulhu_roll_1d20_table$2,
            $PulpCthulhu_roll_bmr_table$3,
            $PulpCthulhu_roll_bms_table$4;
        self.$$prototype.randomizer = nil;
        ...
        Opal.def(self, '$eval_game_system_specific_command', $PulpCthulhu_eval_game_system_specific_command$1 = function $$eval_game_system_specific_command(command) {
          ...
          return function () {
            ...
            if (/^CC/i['$===']($case)) {
              ...
              return self.$roll_1d20_table("キャスティング・ロール失敗表", $$($nesting, 'FAILED_CASTING_EFFECTS_TABLE'));
            } else if (/^PH/i['$===']($case)) {
              return self.$roll_1d100_table("恐怖症表", $$($nesting, 'PHOBIAS_TABLE'));
            } else if (/^MA/i['$===']($case)) {
              return self.$roll_1d100_table("マニア表", $$($nesting, 'MANIAS_TABLE'));
            } else if (/^IT/i['$===']($case)) {
              return self.$roll_1d20_table("狂気のタレント表", $$($nesting, 'INSANE_TALENTS_TABLE'));
            } else {
              return nil;
            }
          }();
...
//# sourceMappingURL=default~PulpCthulhu~index.js.map