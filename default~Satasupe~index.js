(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Satasupe~index"],{

/***/ "9L+J":
/*!****************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Satasupe.js ***!
  \****************************************************************/
...
Opal.modules["bcdice/game_system/satasupe/tables"] = function (Opal) {
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting);
        Opal.const_set($nesting[0], 'TAG_TABLE', $$$($$($nesting, 'DiceTable'), 'D66GridTable').$new("タグ決定表", [["情報イベント", "アブノーマル(サ)", "カワイイ(サ)", "トンデモ(サ)", "マニア(サ)", "ヲタク(サ)"], ["音楽(ア)", "好きなタグ", "トレンド(ア)", "読書(ア)", "パフォーマンス(ア)", "美術(ア)"], ["アラサガシ(マ)", "おせっかい(マ)", "好きなタグ", "家事(マ)", "ガリ勉(マ)", "健康(マ)"], ["アウトドア(休)", "工作(休)", "スポーツ(休)", "同一タグ", "ハイソ(休)", "旅行(休)"], ["育成(イ)", "サビシガリヤ(イ)", "ヒマツブシ(イ)", "宗教(イ)", "同一タグ", "ワビサビ(イ)"], ["アダルト(風)", "飲食(風)", "ギャンブル(風)", "ゴシップ(風)", "ファッション(風)", "情報ハプニング"]]));
        Opal.const_set($nesting[0], 'CREATE_ARMS_ACCESSORY_TABLE', $hash(11, ["「パチンコ玉」", "「武器破壊」", $send(self, 'lambda', [], ($$1 = function (_$$) {
          function $$1(_x, _x2) {
          ...
          ;
          return arm.$abilities()['$<<']("「武器破壊」");
        }), $$1.$$s = self, $$1.$$arity = 2, $$1))].$freeze(), 12, ["「釘や画鋲、針」", "「毒」", $send(self, 'lambda', [], ($$2 = function (_$$2) {
          function $$2(_x3, _x4) {
          ...
          ;
          return arm.$abilities()['$<<']("「毒」");
        }), $$2.$$s = self, $$2.$$arity = 2, $$2))].$freeze(), 13, ["「砂利や小石、ガラスの破片」", "「散弾」", $send(self, 'lambda', [], ($$3 = function (_$$3) {
          function $$3(_x5, _x6) {
          ...
          ;
          return arm.$abilities()['$<<']("「散弾」");
        }), $$3.$$s = self, $$3.$$arity = 2, $$3))].$freeze(), 14, ["「口紅」", "「（判定前宣言）一度だけ必殺10」", $send(self, 'lambda', [], ($$4 = function (_$$4) {
          function $$4(_x7, _x8) {
          ...
          ;
          $writer = [$rb_plus(arm.$kutibeni(), 1)];
          $send(arm, 'kutibeni=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }), $$4.$$s = self, $$4.$$arity = 2, $$4))].$freeze(), 15, ["「バネやゼンマイ」", "「フル」", $send(self, 'lambda', [], ($$5 = function (_$$5) {
          function $$5(_x9, _x10) {
          ...
          ;
          return arm.$abilities()['$<<']("「フル」");
        }), $$5.$$s = self, $$5.$$arity = 2, $$5))].$freeze(), 16, ["「捻子やビス」", "「ダメージ＋１」", $send(self, 'lambda', [], ($$6 = function (_$$6) {
          function $$6(_x11, _x12) {
          ...
          ;
          $writer = [$rb_plus(arm.$damage(), 1)];
          $send(arm, 'damage=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }), $$6.$$s = self, $$6.$$arity = 2, $$6))].$freeze(), 22, ["「生ゴミ」", "「衝撃」", $send(self, 'lambda', [], ($$7 = function (_$$7) {
          function $$7(_x13, _x14) {
          ...
          ;
          return arm.$abilities()['$<<']("「衝撃」");
        }), $$7.$$s = self, $$7.$$arity = 2, $$7))].$freeze(), 23, ["「ゴム」", "「ダメージ＋１」", $send(self, 'lambda', [], ($$8 = function (_$$8) {
          function $$8(_x15, _x16) {
          ...
          $send(arm, 'damage=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }), $$8.$$s = self, $$8.$$arity = 2, $$8))].$freeze(), 24, ["「歯車」", "「リボルバー」", $send(self, 'lambda', [], ($$9 = function (_$$9) {
          function $$9(_x17, _x18) {
          ...
          ;
          return arm.$abilities()['$<<']("「リボルバー」");
        }), $$9.$$s = self, $$9.$$arity = 2, $$9))].$freeze(), 25, ["「歯や牙、骨」", "「（判定前宣言）1D6回、ダメージ＋２」", $send(self, 'lambda', [], ($$10 = function (_$$10) {
          function $$10(_x19, _x20) {
          ...
          ;
          $writer = [r.$roll_once(6)];
          $send(arm, 'kiba=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }), $$10.$$s = self, $$10.$$arity = 2, $$10))].$freeze(), 26, ["「ワイヤー」", "「耐久度＋１」", $send(self, 'lambda', [], ($$11 = function (_$$11) {
          function $$11(_x21, _x22) {
          ...
          ;
          $writer = [$rb_plus(arm.$life(), 1)];
          $send(arm, 'life=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }), $$11.$$s = self, $$11.$$arity = 2, $$11))].$freeze(), 33, ["「メガネなどのレンズ」", "「命中－１」", $send(self, 'lambda', [], ($$12 = function (_$$12) {
          function $$12(_x23, _x24) {
          ...
          ;
          $writer = [$rb_minus(arm.$hit(), 1)];
          $send(arm, 'hit=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }), $$12.$$s = self, $$12.$$arity = 2, $$12))].$freeze(), 34, ["「マッチ」", "「必殺12」", $send(self, 'lambda', [], ($$13 = function (_$$13) {
          function $$13(_x25, _x26) {
          ...
          ;
          return arm.$abilities()['$<<']("「必殺12」");
        }), $$13.$$s = self, $$13.$$arity = 2, $$13))].$freeze(), 35, ["「ガムテープや接着剤」", "「耐久度＋１」", $send(self, 'lambda', [], ($$14 = function (_$$14) {
          function $$14(_x27, _x28) {
          ...
          $send(arm, 'life=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }), $$14.$$s = self, $$14.$$arity = 2, $$14))].$freeze(), 36, ["「洗濯ばさみ」", "「命中－１」", $send(self, 'lambda', [], ($$15 = function (_$$15) {
          function $$15(_x29, _x30) {
          ...
          $send(arm, 'hit=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }), $$15.$$s = self, $$15.$$arity = 2, $$15))].$freeze(), 44, ["「花火」", "「弾幕1」", $send(self, 'lambda', [], ($$16 = function (_$$16) {
          function $$16(_x31, _x32) {
          ...
          ;
          return arm.$abilities()['$<<']("「弾幕1」");
        }), $$16.$$s = self, $$16.$$arity = 2, $$16))].$freeze(), 45, ["「食玩」", "「暗器」", $send(self, 'lambda', [], ($$17 = function (_$$17) {
          function $$17(_x33, _x34) {
          ...
          ;
          return arm.$abilities()['$<<']("「暗器」");
        }), $$17.$$s = self, $$17.$$arity = 2, $$17))].$freeze(), 46, ["「真空管やトランジスタ」", "「神秘」", $send(self, 'lambda', [], ($$18 = function (_$$18) {
          function $$18(_x35, _x36) {
          ...
          ;
          return arm.$abilities()['$<<']("「神秘」");
        }), $$18.$$s = self, $$18.$$arity = 2, $$18))].$freeze(), 55, ["「エアコンプレッサ」", "「ダメージ＋１」", $send(self, 'lambda', [], ($$19 = function (_$$19) {
          function $$19(_x37, _x38) {
          ...
          $send(arm, 'damage=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }), $$19.$$s = self, $$19.$$arity = 2, $$19))].$freeze(), 56, ["「豆」", "「マヒ」", $send(self, 'lambda', [], ($$20 = function (_$$20) {
          function $$20(_x39, _x40) {
          ...
          ;
          return arm.$abilities()['$<<']("「マヒ」");
        }), $$20.$$s = self, $$20.$$arity = 2, $$20))].$freeze(), 66, ["「ガスボンベや殺虫剤」", "「爆発3」", $send(self, 'lambda', [], ($$21 = function (_$$21) {
          function $$21(_x41, _x42) {
        ...
        }), 'transform_keys', [], "upcase".$to_proc()), 'transform_values', [], "upcase".$to_proc()).$freeze());
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        var self = $klass($base, $super, 'Satasupe');
        var $nesting = [self].concat($parent_nesting),
            $Satasupe_initialize$1,
            $Satasupe_eval_game_system_specific_command$2,
            $Satasupe_checkRoll$3,
            $Satasupe_getRollParams$4,
            $Satasupe_getJudgeInfo$5,
            $Satasupe_getcriticalString$6,
            $Satasupe_checkRollLoop$7,
            $Satasupe_check_seigou$9,
            $Satasupe_rollTableCommand$10,
            $Satasupe_getTagTableResult$11,
            $Satasupe_getCreateSatasupeResult$13,
            $Satasupe_getNpcTableResult$15,
            $Satasupe_getAnotherTableResult$17,
            $Satasupe_getTableIndex$19;
        ...
        self.$register_prefix("\\d+R", "SR", "TAGT", "GETSST", "NPCT", $$($nesting, 'TABLES').$keys(), $$($nesting, 'ALIASES').$keys());
        Opal.const_set($nesting[0], 'CREATE_ARMS_STRUCT', $$($nesting, 'Struct').$new("base_parts", "accessory_parts", "parts_effect", "hit", "damage", "life", "kutibeni", "kiba", "abilities"));
        Opal.def(self, '$initialize', $Satasupe_initialize$1 = function $$initialize(command) {
          var $iter = $Satasupe_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $Satasupe_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $Satasupe_initialize$1, false, true), 'initialize', [command], null);
          self.sort_add_dice = true;
          return self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'ASC');
        }, $Satasupe_initialize$1.$$arity = 1);
        Opal.def(self, '$eval_game_system_specific_command', $Satasupe_eval_game_system_specific_command$2 = function $$eval_game_system_specific_command(command) {
          var self = this,
              result = nil;
        ...
        }, $Satasupe_eval_game_system_specific_command$2.$$arity = 1);
        Opal.def(self, '$checkRoll', $Satasupe_checkRoll$3 = function $$checkRoll(string) {
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_1 = $rb_lt(critical, 1))) {
              return $ret_or_1;
            } else {
              return $rb_gt(critical, 12);
            }
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_2 = isCritical)) {
              return $rb_gt(total_suc, 0);
            } else {
              return $ret_or_2;
            }
        ...
        Opal.def(self, '$getRollParams', $Satasupe_getRollParams$4 = function $$getRollParams(params) {
          ...
          if ($truthy(params['$nil?']())) {} else {
            m = /\[(\d*)(,(\d*)?)?(,(\d*)(S)?)?\]/.$match(params);

            if ($truthy(m)) {
              min_suc = m['$[]'](1).$to_i();

              if ($truthy(m['$[]'](3).$to_i()['$!='](0))) {
                fumble = m['$[]'](3).$to_i();
              }
        ...
        Opal.def(self, '$checkRollLoop', $Satasupe_checkRollLoop$7 = function $$checkRollLoop(roll_times, min_suc, target, critical, fumble, isCriticalStop) {
          ...
          (function () {
            ...
            try {
              return $send(roll_times, 'times', [], ($$8 = function (_$$22) {
                function $$8(_x43) {
                ...
                if ($truthy(function () {
                  if ($truthy($ret_or_3 = min_suc['$!='](0))) {
                    return $rb_ge(total_suc, min_suc);
                  } else {
                    return $ret_or_3;
                  }
                ...
                if ($truthy(function () {
                  if ($truthy($ret_or_4 = d1['$=='](d2))) {
                    return $rb_le(d1, fumble);
                  } else {
                    return $ret_or_4;
                  }
                ...
                if ($truthy(function () {
                  if ($truthy($ret_or_5 = isCritical)) {
                    return isCriticalStop;
                  } else {
                    return $ret_or_5;
                  }
        ...
        Opal.def(self, '$check_seigou', $Satasupe_check_seigou$9 = function $$check_seigou(string) {
          ...
          ;
          target = m['$[]'](1).$to_i();
          sr_parser = $$$($$($nesting, 'Command'), 'Parser').$new(/SR\d+/i, $hash2(["round_type"], {
          ...
          seigou = function () {
            if ($truthy($rb_lt(target, diceTotal))) {
              return "「激」";
            } else if ($truthy($rb_gt(target, diceTotal))) {
              return "「律」";
            } else {
              return "「迷」";
            }
        ...
        Opal.def(self, '$getTagTableResult', $Satasupe_getTagTableResult$11 = function $$getTagTableResult(counts) {
          var $$12,
              ...
              result = nil;
          result = [];
          $send(counts, 'times', [], ($$12 = function (_$$23) {
            function $$12(_x44) {
            ...
            ;
            roll_result = $$($nesting, 'TAG_TABLE').$roll(self.randomizer);
            return result.$push("" + roll_result.$table_name() + ":" + roll_result.$value() + ":" + roll_result.$body());
        ...
        Opal.def(self, '$getCreateSatasupeResult', $Satasupe_getCreateSatasupeResult$13 = function $$getCreateSatasupeResult(counts) {
          ...
          arm = function () {
            $case = self.randomizer.$roll_once(6);

            if (1['$===']($case)) {
              return $$($nesting, 'CREATE_ARMS_STRUCT').$new("「紙製の筒」", [], ["「命中：10、ダメージ：3、耐久度1」"], 10, 3, 1, 0, 0, []);
            } else if (2['$===']($case)) {
              return $$($nesting, 'CREATE_ARMS_STRUCT').$new("「木製の筒」", [], ["「命中：9、ダメージ：3、耐久度2」"], 9, 3, 2, 0, 0, []);
            } else if (3['$===']($case)) {
              return $$($nesting, 'CREATE_ARMS_STRUCT').$new("「小型のプラスチック製の筒」", [], ["「命中：9、ダメージ：4、耐久度2」"], 9, 4, 2, 0, 0, []);
            } else if (4['$===']($case)) {
              return $$($nesting, 'CREATE_ARMS_STRUCT').$new("「大型のプラスチック製の筒」", [], ["「命中：8、ダメージ：3、耐久度2、両手」"], 8, 3, 2, 0, 0, ["「両手」"]);
            } else if (5['$===']($case)) {
              return $$($nesting, 'CREATE_ARMS_STRUCT').$new("「小型の金属製の筒」", [], ["「命中：9、ダメージ：4、耐久度3」"], 9, 4, 3, 0, 0, []);
            } else if (6['$===']($case)) {
              return $$($nesting, 'CREATE_ARMS_STRUCT').$new("「大型の金属製の筒」", [], ["「命中：8、ダメージ：5、耐久度3、両手」"], 8, 5, 3, 0, 0, ["「両手」"]);
            } else {
              return nil;
            }
          }();

          $send(counts, 'times', [], ($$14 = function (_$$24) {
            function $$14(_x45) {
            ...
            ;
            $b = $$($nesting, 'CREATE_ARMS_ACCESSORY_TABLE')['$[]'](self.randomizer.$roll_d66($$$($$($nesting, 'D66SortType'), 'ASC'))), $a = Opal.to_ary($b), part = $a[0] == null ? nil : $a[0], effect = $a[1] == null ? nil : $a[1], modifier = $a[2] == null ? nil : $a[2], $b;
            arm.$accessory_parts()['$<<'](part);
            arm.$parts_effect()['$<<'](effect);
            return modifier.$call(arm, self.randomizer);
        ...
        Opal.def(self, '$getNpcTableResult', $Satasupe_getNpcTableResult$15 = function $$getNpcTableResult(counts) {
          ...
          name = "NPC表:";
          result = [];
          $send(counts, 'times', [], ($$16 = function (_$$25) {
            function $$16(_x46) {
            ...
            ;
            $b = $$($nesting, 'NPC_AGE_TABLE')['$[]'](self.randomizer.$roll_index(6)), $a = Opal.to_ary($b), age = $a[0] == null ? nil : $a[0], agen_const = $a[1] == null ? nil : $a[1], agen_times = $a[2] == null ? nil : $a[2], $b;
            ysold = $rb_plus(self.randomizer.$roll_sum(agen_times, 6), agen_const);
            lmodValue = $$($nesting, 'NPC_LMOOD_TABLE')['$[]'](self.randomizer.$roll_index(6));
            lageValue = $$($nesting, 'NPC_LAGE_TABLE')['$[]'](self.randomizer.$roll_index(3));
        ...
        Opal.def(self, '$getAnotherTableResult', $Satasupe_getAnotherTableResult$17 = function $$getAnotherTableResult(command, counts, operator, value) {
          ...
          table_name = function () {
            if ($truthy($ret_or_6 = $$($nesting, 'ALIASES')['$[]'](command))) {
              return $ret_or_6;
            } else {
              return command;
            }
          ...
          table = $$($nesting, 'TABLES')['$[]'](table_name);
          ...
          ;
          $send(counts, 'times', [], ($$18 = function (_$$26) {
            function $$18(_x47) {
            ...
            ;
            $b = self.$getTableIndex(operator, value, 2, 6), $a = Opal.to_ary($b), _ = $a[0] == null ? nil : $a[0], index = $a[1] == null ? nil : $a[1], $b;
        ...
        return (Opal.def(self, '$getTableIndex', $Satasupe_getTableIndex$19 = function $$getTableIndex(operator, value, diceCount, diceType) {
          var self = this,
              index = nil,
              modify = nil,
              $case = nil;
          ...
          return [modify, index];
        }, $Satasupe_getTableIndex$19.$$arity = 4), nil) && 'getTableIndex';
      })($nesting[0], $$($nesting, 'Base'), $nesting);
    })($nesting[0], $nesting);
  }($nesting[0], $nesting);
})(Opal);
...
//# sourceMappingURL=default~Satasupe~index.js.map