(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~SwordWorld2_5~index"],{

/***/ "CAdq":
/*!*********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/SwordWorld2_5.js ***!
  \*********************************************************************/
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        return function ($base, $super, $parent_nesting) {
          ...
          var $nesting = [self].concat($parent_nesting),
              $TranscendentTest_initialize$1,
              $TranscendentTest_execute$2,
              $TranscendentTest_node_expression$4,
              $TranscendentTest_sum_of_dice$5,
              $TranscendentTest_dice_str$6,
              $TranscendentTest_result_status$8;
          ...
          Opal.const_set($nesting[0], 'RESULT_STR', $hash2(["success", "failure", "super_success", "critical", "fumble"], {
            "success": "成功",
            "failure": "失敗",
            "super_success": "超成功",
            "critical": "自動的成功",
          ...
          Opal.def(self, '$execute', $TranscendentTest_execute$2 = function $$execute(randomizer) {
            ...
            return $send($$($nesting, 'Result').$new(), 'tap', [], (_$$40 = function $$3(r) {
              var self = _$$40.$$s == null ? this : _$$40.$$s,
                  $writer = nil;
          ...
          Opal.def(self, '$dice_str', $TranscendentTest_dice_str$6 = function $$dice_str(value_groups, sum) {
            var _$$41,
                self = this,
                value_groups_str = nil;

            value_groups_str = $send(value_groups, 'map', [], (_$$41 = function $$7(values) {
              var self = _$$41.$$s == null ? this : _$$41.$$s;
              ...
              ;
              return "" + "[" + values.$join(",") + "]";
            }, _$$41.$$s = self, _$$41.$$arity = 1, _$$41)).$join();
          ...
          return (Opal.def(self, '$result_status', $TranscendentTest_result_status$8 = function $$result_status(total_sum, n_value_groups, fumble, critical) {
            ...
            if ($truthy(total_sum.$send(self.cmp_op, self.target))) {
              if ($truthy(function () {
                if ($truthy($ret_or_2 = $rb_ge(n_value_groups, 2))) {
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        var self = $klass($base, $super, 'SwordWorld2_0');
        var $nesting = [self].concat($parent_nesting),
            $SwordWorld2_0_initialize$1,
            $SwordWorld2_0_eval_game_system_specific_command$2,
            $SwordWorld2_0_rating_parser$3,
            $SwordWorld2_0_rollDice$4,
            $SwordWorld2_0_growth$5,
            $SwordWorld2_0_growth_step$7,
            $SwordWorld2_0_get_ability_by_dice$8,
            $SwordWorld2_0_get_fumble_table$9,
            $SwordWorld2_0_get_tangle_table$10;
        self.$$prototype.randomizer = nil;
        Opal.const_set($nesting[0], 'ID', "SwordWorld2.0");
        Opal.const_set($nesting[0], 'NAME', "ソード・ワールド2.0");
        ...
        Opal.def(self, '$initialize', $SwordWorld2_0_initialize$1 = function $$initialize(command) {
          var $iter = $SwordWorld2_0_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
        ...
        Opal.def(self, '$eval_game_system_specific_command', $SwordWorld2_0_eval_game_system_specific_command$2 = function $$eval_game_system_specific_command(command) {
          var $iter = $SwordWorld2_0_eval_game_system_specific_command$2.$$p,
              $yield = $iter || nil,
              self = this,
              $case = nil,
              transcendent_parser = nil,
              cmd = nil,
              node = nil;
          ...
          return function () {
            ...
            if (/^Gr(\d+)?/i['$===']($case)) {
              ...
              transcendent_parser = $$$($$($nesting, 'Command'), 'Parser').$new(/2D6?/i, $hash2(["round_type"], {
                "round_type": $$$($$$($$($nesting, 'BCDice'), 'RoundType'), 'CEIL')
              ...
              return $send2(self, Opal.find_super_dispatcher(self, 'eval_game_system_specific_command', $SwordWorld2_0_eval_game_system_specific_command$2, false, true), 'eval_game_system_specific_command', [command], null);
            }
          }();
        ...
        Opal.def(self, '$growth', $SwordWorld2_0_growth$5 = function $$growth(count) {
          ...
          ;
          return $send(Opal.Range.$new(1, count, false), 'map', [], (_$$42 = function $$6() {
            var self = _$$42.$$s == null ? this : _$$42.$$s;
            return self.$growth_step();
          }, _$$42.$$s = self, _$$42.$$arity = 0, _$$42)).$join(" | ");
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $SwordWorld2_5_eval_game_system_specific_command$1,
            $SwordWorld2_5_rating_parser$2,
            $SwordWorld2_5_druid_dice$3,
            $SwordWorld2_5_get_abyss_curse_table$4;
        self.$$prototype.randomizer = nil;
        Opal.const_set($nesting[0], 'ID', "SwordWorld2.5");
        Opal.const_set($nesting[0], 'NAME', "ソード・ワールド2.5");
        ...
        Opal.def(self, '$eval_game_system_specific_command', $SwordWorld2_5_eval_game_system_specific_command$1 = function $$eval_game_system_specific_command(command) {
          var $iter = $SwordWorld2_5_eval_game_system_specific_command$1.$$p,
              $yield = $iter || nil,
              self = this,
              $case = nil,
              power_list = nil,
          ...
          return function () {
            ...
            if (/^dru\[(\d+),(\d+),(\d+)\]/i['$===']($case)) {
              ...
              druid_parser = $$$($$($nesting, 'Command'), 'Parser').$new(/dru\[\d+,\d+,\d+\]/i, $hash2(["round_type"], {
                "round_type": $$$($$$($$($nesting, 'BCDice'), 'RoundType'), 'CEIL')
              }));
              ...
              return $send2(self, Opal.find_super_dispatcher(self, 'eval_game_system_specific_command', $SwordWorld2_5_eval_game_system_specific_command$1, false, true), 'eval_game_system_specific_command', [command], null);
            }
          }();
        ...
        Opal.def(self, '$druid_dice', $SwordWorld2_5_druid_dice$3 = function $$druid_dice(command, power_list) {
          ...
          offset = function () {
            ...
            if ($range(2, 6, false)['$===']($case)) {
              return 0;
            } else if ($range(7, 9, false)['$===']($case)) {
              return 1;
            } else if ($range(10, 12, false)['$===']($case)) {
              return 2;
            } else {
              return nil;
            }
        ...
        return (Opal.def(self, '$get_abyss_curse_table', $SwordWorld2_5_get_abyss_curse_table$4 = function $$get_abyss_curse_table() {
          ...
          additional = function () {
            ...
            if (14['$===']($case)) {
              return $$($nesting, 'ABYSS_CURSE_CATEGORY_TABLE').$roll(self.randomizer).$to_s();
            } else if (25['$===']($case)) {
              return $$($nesting, 'ABYSS_CURSE_ATTR_TABLE').$roll(self.randomizer).$to_s();
            } else {
              return nil;
            }
          }();
...
//# sourceMappingURL=default~SwordWorld2_5~index.js.map