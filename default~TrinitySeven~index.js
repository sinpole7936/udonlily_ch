(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~TrinitySeven~index"],{

/***/ "Bf0i":
/*!********************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/TrinitySeven.js ***!
  \********************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $TrinitySeven_eval_game_system_specific_command$1,
            $TrinitySeven_rollHit$2,
            $TrinitySeven_getHitRollResult$3,
            $TrinitySeven_rollDamage$4,
            $TrinitySeven_getRollDamageCritialText$5,
            $TrinitySeven_result_1d100$8,
            $TrinitySeven_get_NAME_table$9,
            $TrinitySeven_get_NAMEtwo_table$10;
        ...
        Opal.def(self, '$rollDamage', $TrinitySeven_rollDamage$4 = function $$rollDamage(command, diceCount, critical, modify) {
          ...
          if ($truthy(additionalList['$empty?']())) {} else {
        ...
        Opal.def(self, '$getRollDamageCritialText', $TrinitySeven_getRollDamageCritialText$5 = function $$getRollDamageCritialText(diceCount, critical, total, diceText, modify) {
          ...
          ;
          $send(critical, 'times', [], (_$$ = function $$6() {
          ...
          $send(restDice, 'each', [], (_$$2 = function $$7(i) {
...
//# sourceMappingURL=default~TrinitySeven~index.js.map