(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Villaciel~index"],{

/***/ "ozu2":
/*!*****************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Villaciel.js ***!
  \*****************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $Villaciel_initialize$1,
            $Villaciel_eval_game_system_specific_command$2,
            $Villaciel_derive_achievement$3,
            $Villaciel_resolute_action$5,
            $Villaciel_resolute_frontier_action$6,
            $Villaciel_resolute_difficult_action$7,
            $Villaciel_resolute_mining_action$8,
            $Villaciel_resolute_cutting_gem_action$9,
            $Villaciel_use_previous_job_chart$10,
            $Villaciel_use_petit_quest_chart$11,
            $Villaciel_use_accident_chart$12,
            $Villaciel_use_6x6_chart$13,
            $Villaciel_use_mohumohu_chart$14,
            $Villaciel_use_fishing_chart$15,
            $Villaciel_use_inedible_plant_chart$16,
            $Villaciel_use_villaciel_edible_plant_chart$17,
            $Villaciel_use_armesear_edible_plant_chart$18,
            $Villaciel_use_edible_plant_chart$19,
            $Villaciel_use_mutant_plant_chart$20,
            $Villaciel_use_improved_species_chart$21;
        ...
        Opal.def(self, '$initialize', $Villaciel_initialize$1 = function $$initialize(command) {
          var $iter = $Villaciel_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $Villaciel_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $Villaciel_initialize$1, false, true), 'initialize', [command], null);
          self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'NO_SORT');
          return self.round_type = $$$($$($nesting, 'RoundType'), 'CEIL');
        }, $Villaciel_initialize$1.$$arity = 1);
        Opal.def(self, '$eval_game_system_specific_command', $Villaciel_eval_game_system_specific_command$2 = function $$eval_game_system_specific_command(command) {
          var self = this,
              $case = nil;
          return function () {
            $case = command;
        ...
        }, $Villaciel_eval_game_system_specific_command$2.$$arity = 1);
        self.$private();
        ...
        Opal.def(self, '$derive_achievement', $Villaciel_derive_achievement$3 = function $$derive_achievement(num_dices, command) {
          var _$$,
              ...
              dice_list = nil,
              dice_str = nil,
              num_triumph_dices = nil,
              num_successes = nil,
              achievement = nil,
              output = nil;

          dice_list = self.randomizer.$roll_barabara(num_dices, $$($nesting, 'D6'));
          dice_str = dice_list.$join(",");
          num_triumph_dices = dice_list.$count(6);
          num_successes = $send(dice_list, 'count', [], (_$$ = function $$4(dice) {
            ...
            ;
            return $rb_ge(dice, $$($nesting, 'LEAST_SUCCESS_ROLL'));
        ...
        Opal.def(self, '$resolute_action', $Villaciel_resolute_action$5 = function $$resolute_action(command) {
          var $a,
              $b,
              self = this,
              match_data = nil,
          ...
          output = $rb_plus(output, function () {
            if ($truthy($rb_ge(achievement, difficulty))) {
          ...
          return output;
        }, $Villaciel_resolute_action$5.$$arity = 1);
        ...
        Opal.def(self, '$resolute_frontier_action', $Villaciel_resolute_frontier_action$6 = function $$resolute_frontier_action(command) {
          var $a,
              $b,
              self = this,
              num_dices = nil,
          ...
          chart_index = function () {
            ...
            if ($range(0, 2, false)['$===']($case)) {
              return achievement;
            } else if (3['$===']($case) || 4['$===']($case)) {
              return 3;
            } else if ($range(5, 8, false)['$===']($case)) {
              return 4;
            } else {
              return 5;
            }
          ...
          skill = $$($nesting, 'SKILL_CHART')['$[]'](chart_index);
          return "" + output + " ＞ " + skill;
        }, $Villaciel_resolute_frontier_action$6.$$arity = 1);
        Opal.def(self, '$resolute_difficult_action', $Villaciel_resolute_difficult_action$7 = function $$resolute_difficult_action(num_dices, least_success_roll, command) {
          var self = this,
              dice_list = nil,
              dice_str = nil,
              largest_roll = nil,
        ...
        }, $Villaciel_resolute_difficult_action$7.$$arity = 3);
        Opal.const_set($nesting[0], 'LEAST_MINING_SUCCESS_ROLL', 5);
        Opal.const_set($nesting[0], 'LEAST_GEM_SUCCESS_ROLL', 6);
        Opal.def(self, '$resolute_mining_action', $Villaciel_resolute_mining_action$8 = function $$resolute_mining_action(command) {
          var $a,
              $b,
              self = this,
              num_dices = nil,
          ...
          if ($truthy(is_successful)) {} else {
            return output;
          }

          ;
          roll_result = self.randomizer.$roll_once($$($nesting, 'D6'));
          return "" + output + " ＞ (1D6) ＞ [" + roll_result + "] ＞ アイテムを" + roll_result + "個獲得";
        }, $Villaciel_resolute_mining_action$8.$$arity = 1);
        Opal.def(self, '$resolute_cutting_gem_action', $Villaciel_resolute_cutting_gem_action$9 = function $$resolute_cutting_gem_action(command) {
          var self = this,
              num_dices = nil;
        ...
        }, $Villaciel_resolute_cutting_gem_action$9.$$arity = 1);
        ...
        Opal.def(self, '$use_previous_job_chart', $Villaciel_use_previous_job_chart$10 = function $$use_previous_job_chart(command) {
          var $a,
              $b,
              self = this,
              match_data = nil,
          ...
          roll_result1 = self.randomizer.$roll_once($$($nesting, 'D6'));
          $b = function () {
            $case = chart_symbol;

            if ("V"['$===']($case)) {
              return self.$get_table_by_1d6($$($nesting, 'VILLACIEL_PREVIOUS_JOB_CHART')['$[]']($rb_divide($rb_minus(roll_result1, 1), 3).$to_i()));
            } else if ("A"['$===']($case)) {
              return self.$get_table_by_1d6($$($nesting, 'ARMESEAR_PREVIOUS_JOB_CHART')['$[]']($rb_divide($rb_minus(roll_result1, 1), 2).$to_i()));
            } else {
              return nil;
            }
          }(), $a = Opal.to_ary($b), chart_text = $a[0] == null ? nil : $a[0], roll_result2 = $a[1] == null ? nil : $a[1], $b;
        ...
        }, $Villaciel_use_previous_job_chart$10.$$arity = 1);
        ...
        Opal.def(self, '$use_petit_quest_chart', $Villaciel_use_petit_quest_chart$11 = function $$use_petit_quest_chart(command) {
          var $a,
              $b,
              self = this,
              match_data = nil,
          ...
          $b = function () {
            ...
            if ("V"['$===']($case)) {
              ...
              return self.$get_table_by_1d6($$($nesting, 'ARMESEAR_PETIT_QUEST_CHART')['$[]']($rb_divide($rb_minus(roll_result1, 1), 2).$to_i()));
            } else {
              return nil;
            }
          }(), $a = Opal.to_ary($b), chart_text = $a[0] == null ? nil : $a[0], roll_result2 = $a[1] == null ? nil : $a[1], $b;
          ...
          chart_title = function () {
            ...
            if ("V"['$===']($case)) {
              return "ぷちクエスト表（ヴィラシエル）";
            } else if ("A"['$===']($case)) {
              return "ぷちクエスト表（アルメサール）";
            } else {
              return nil;
            }
          }();
          ...
          return "" + chart_title + " ＞ [" + roll_result1 + "," + roll_result2 + "] ＞ " + chart_text;
        }, $Villaciel_use_petit_quest_chart$11.$$arity = 1);
        ...
        Opal.def(self, '$use_accident_chart', $Villaciel_use_accident_chart$12 = function $$use_accident_chart(_command) {
          var $a,
              $b,
              self = this,
              chart_text = nil,
        ...
        }, $Villaciel_use_accident_chart$12.$$arity = 1);
        Opal.def(self, '$use_6x6_chart', $Villaciel_use_6x6_chart$13 = function $$use_6x6_chart(chart, chart_name) {
          var $a,
              $b,
              self = this,
              y_roll = nil,
              cell_text = nil,
              x_roll = nil;
          y_roll = self.randomizer.$roll_once($$($nesting, 'D6'));
        ...
        }, $Villaciel_use_6x6_chart$13.$$arity = 2);
        ...
        Opal.def(self, '$use_mohumohu_chart', $Villaciel_use_mohumohu_chart$14 = function $$use_mohumohu_chart(command) {
          var $a,
              $b,
              self = this,
              $case = nil,
          ...
          return function () {
            ...
            if ("MMI"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'MOHUMOHU_INSECT_CHART'), "もふもふ表・昆虫");
            } else if ("MMA"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'MOHUMOHU_ANIMAL_CHART'), "もふもふ表・動物");
            } else if (/MMV[VA]?/['$===']($case)) {
              ...
              return function () {
                ...
                if ("V"['$===']($case)) {
                  ...
                  return "" + "もふもふ表・ヴィラシエル種（ヴィラシエル） ＞ [" + y_roll + "," + x_roll + "] ＞ 下" + function () {
                    if ($truthy(y_roll['$even?']())) {
                      return "偶数";
                    } else {
                      return "奇数";
                    }
                    ...
                    ;
                    return nil;
                  }() + "、右" + x_roll + "マス ＞ " + cell_text;
                } else if ("A"['$===']($case)) {
                  return self.$use_6x6_chart($$($nesting, 'MOHUMOHU_VILLACIEL2_CHART'), "もふもふ表・ヴィラシエル種（アルメサール）");
                } else {
                  return nil;
                }
              }();
            } else if ("MMD"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'MOHUMOHU_DRAGON_CHART'), "もふもふ表・鋼龍種");
            } else {
              return nil;
            }
          }();
        }, $Villaciel_use_mohumohu_chart$14.$$arity = 1);
        ...
        Opal.def(self, '$use_fishing_chart', $Villaciel_use_fishing_chart$15 = function $$use_fishing_chart(command) {
          var self = this,
              $case = nil;
          return function () {
            $case = command;
            ...
            if ("FL"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'FISHING_LAKE_CHART'), "釣り・湖表");
            } else if ("FR"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'FISHING_RIVER_CHART'), "釣り・河表");
            } else if ("FW"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'FISHING_WHITE_CHART'), "釣り・白雲表");
            } else if ("FG"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'FISHING_GRAY_CHART'), "釣り・灰雲表");
            } else if ("FB"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'FISHING_BLACK_CHART'), "釣り・黒雲表");
            } else if ("FC"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'FISHING_COMMON_CHART'), "釣り・共通表");
            } else if ("FS"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'FISHING_SALT_LAKE_CHART'), "釣り・塩湖表");
            } else {
              return nil;
            }
          }();
        }, $Villaciel_use_fishing_chart$15.$$arity = 1);
        ...
        Opal.def(self, '$use_inedible_plant_chart', $Villaciel_use_inedible_plant_chart$16 = function $$use_inedible_plant_chart(command) {
          var self = this,
              match_data = nil,
              chart_symbol = nil,
              $case = nil;
          ...
          return function () {
            ...
            if ("V"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'INEDIBLE_PLANT_CHART'), "不食植物表（ヴィラシエル）");
            } else if ("A"['$===']($case)) {
              return self.$use_6x6_chart($$($nesting, 'INEDIBLE_PLANT2_CHART'), "不食植物表（アルメサール）");
            } else {
              return nil;
            }
          }();
        }, $Villaciel_use_inedible_plant_chart$16.$$arity = 1);
        ...
        Opal.def(self, '$use_villaciel_edible_plant_chart', $Villaciel_use_villaciel_edible_plant_chart$17 = function $$use_villaciel_edible_plant_chart(chart_id, output) {
          var self = this;
          return $rb_plus(output, self.$use_6x6_chart($$($nesting, 'EDIBLE_PLANT_CHARTS')['$[]']($rb_minus(chart_id, 1)), "" + "可食植物表" + chart_id + "（ヴィラシエル）"));
        }, $Villaciel_use_villaciel_edible_plant_chart$17.$$arity = 2);
        Opal.def(self, '$use_armesear_edible_plant_chart', $Villaciel_use_armesear_edible_plant_chart$18 = function $$use_armesear_edible_plant_chart(chart_id, output) {
          var self = this;
          return $rb_plus(output, self.$use_6x6_chart($$($nesting, 'EDIBLE_PLANT2_CHARTS')['$[]']($rb_minus(chart_id, 1)), "" + "可食植物表" + chart_id + "（アルメサール）"));
        }, $Villaciel_use_armesear_edible_plant_chart$18.$$arity = 2);
        Opal.def(self, '$use_edible_plant_chart', $Villaciel_use_edible_plant_chart$19 = function $$use_edible_plant_chart(command) {
          var self = this,
              match_data = nil,
              chart_symbol = nil,
              $case = nil,
            ...
            if ("V"['$===']($case)) {
              return function () {
                ...
                if (""['$===']($case)) {
                  ...
                  if ($truthy(function () {
                    if ($truthy($ret_or_1 = $rb_ge(chart_id, 1))) {
                      return $rb_le(chart_id, 5);
                    } else {
                      return $ret_or_1;
                    }
              ...
              return function () {
                ...
                if (""['$===']($case)) {
                  roll_result = self.randomizer.$roll_once($$($nesting, 'D6'));
                  return self.$use_armesear_edible_plant_chart(function () {
                    if ($truthy(roll_result['$even?']())) {
                      return 1;
                    } else {
                      return 2;
                    }
                  ...
                  if ($truthy([1, 2]['$include?'](chart_id))) {} else {
                    return "";
                  }
        ...
        }, $Villaciel_use_edible_plant_chart$19.$$arity = 1);
        ...
        Opal.def(self, '$use_mutant_plant_chart', $Villaciel_use_mutant_plant_chart$20 = function $$use_mutant_plant_chart(_command) {
          var self = this;
          return self.$use_6x6_chart($$($nesting, 'MUTANT_PLANT_CHART'), "変異植物表");
        }, $Villaciel_use_mutant_plant_chart$20.$$arity = 1);
        ...
        return (Opal.def(self, '$use_improved_species_chart', $Villaciel_use_improved_species_chart$21 = function $$use_improved_species_chart(_command) {
          var self = this;
          return self.$use_6x6_chart($$($nesting, 'IMPROVED_SPECIES_CHART'), "改良種表");
        }, $Villaciel_use_improved_species_chart$21.$$arity = 1), nil) && 'use_improved_species_chart';
...
//# sourceMappingURL=default~Villaciel~index.js.map