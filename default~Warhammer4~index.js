(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Warhammer4~index"],{

/***/ "9ZF9":
/*!******************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Warhammer4.js ***!
  \******************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $Warhammer4_initialize$1,
            $Warhammer4_eval_game_system_specific_command$2,
            $Warhammer4_result_1d100$3,
            $Warhammer4_result_detail$4,
            $Warhammer4_roll_critical_table$5,
            $Warhammer4_roll_attack$9,
            $Warhammer4_additional_result$10,
            $Warhammer4_split_d100$11,
            $Warhammer4_merge_d100$12;
        ...
        Opal.def(self, '$initialize', $Warhammer4_initialize$1 = function $$initialize(command) {
          var $iter = $Warhammer4_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
        ...
        Opal.def(self, '$eval_game_system_specific_command', $Warhammer4_eval_game_system_specific_command$2 = function $$eval_game_system_specific_command(command) {
          ...
          if ($truthy($ret_or_1 = function () {
            if ($truthy($ret_or_2 = self.$roll_critical_table(command))) {
              return $ret_or_2;
            } else {
        ...
        Opal.def(self, '$result_1d100', $Warhammer4_result_1d100$3 = function $$result_1d100(total, _dice_total, cmp_op, target) {
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_3 = $rb_le(total, 5))) {
              return $rb_lt(sl, 1);
            } else {
              return $ret_or_3;
            }
            ...
            if ($truthy($ret_or_4 = $rb_ge(total, 96))) {
              return $rb_gt(sl, -1);
            } else {
              return $ret_or_4;
            }
        ...
        (function ($base, $super, $parent_nesting) {
          ...
          var $nesting = [self].concat($parent_nesting),
              $CriticalTable_initialize$6,
              $CriticalTable_roll$7;
          ...
          return (Opal.def(self, '$roll', $CriticalTable_roll$7 = function $$roll(randomizer, under_ganken_bonus) {
            ...
            ;
            chosen = $send(self.items, 'find', [], (_$$ = function $$8(key, _) {
        ...
        Opal.def(self, '$additional_result', $Warhammer4_additional_result$10 = function $$additional_result(total, target_number) {
          ...
          if ($truthy(function () {
            if ($truthy($ret_or_5 = $rb_gt(total, target_number))) {
              return $ret_or_5;
            } else {
        ...
        return Opal.const_set($nesting[0], 'TABLES', $hash2(["WHLT", "WHFT"], {
          "WHLT": $$($nesting, 'HIT_PARTS_TABLE'),
          "WHFT": $$$($$($nesting, 'DiceTable'), 'RangeTable').$new("やっちまった！表", "1D100", [[$range(1, 20, false), "君は自分の体の一部に当ててしまった。「耐久度」1点を失う。"], [$range(21, 40, false), "君の武器が1ダメージを受ける。次のラウンドの行動順が一番最後になる。"], [$range(41, 60, false), "君は身体動作の目算を誤る。次のラウンドのアクションに-10。"], [$range(61, 70, false), "君はひどく躓きバランスを回復するのに手間取る。次の「移動」を失う。"], [$range(71, 80, false), "君は武器を取り回しを誤る。次の「アクション」を失う。"], [$range(81, 90, false), "君は筋を違えるか、足首をひねってしまう。「筋断裂(軽度)」の負傷を得る。「致命的負傷」としてカウントされる。"], [$range(91, 100, false), "君は射程内のランダムな味方を攻撃してしまう。命中判定の出目の1の位をSLとして用いること。攻撃可能な味方が居ない場合は、自己を攻撃してしまい「朦朧状態」1つを得る。"]])
        }).$freeze());
...
//# sourceMappingURL=default~Warhammer4~index.js.map