(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~WitchQuest~index"],{

/***/ "1Rc4":
/*!******************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/WitchQuest.js ***!
  \******************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $WitchQuest_eval_game_system_specific_command$1,
            $WitchQuest_challenge$2,
            $WitchQuest_getSuccessText$4,
            $WitchQuest_getStructureEncounter$5,
            $WitchQuest_getPersonTable1$6,
            $WitchQuest_getPersonTable2$8,
            $WitchQuest_getPersonTable3$10,
            $WitchQuest_getPersonTable4$12,
            $WitchQuest_getPersonTable$13;
        ...
        Opal.def(self, '$getPersonTable1', $WitchQuest_getPersonTable1$6 = function $$getPersonTable1() {
          var self = this,
              gotoNextTable = nil,
              table = nil;
          gotoNextTable = $send(self, 'lambda', [], ($$7 = function (_$$2) {
            function $$7() {
            ...
            return $rb_plus("表２へ", self.$getPersonTable2());
        ...
        Opal.def(self, '$getPersonTable2', $WitchQuest_getPersonTable2$8 = function $$getPersonTable2() {
          var self = this,
              gotoNextTable = nil,
              table = nil;
          gotoNextTable = $send(self, 'lambda', [], ($$9 = function (_$$3) {
            function $$9() {
            ...
            return $rb_plus("表３へ", self.$getPersonTable3());
        ...
        Opal.def(self, '$getPersonTable3', $WitchQuest_getPersonTable3$10 = function $$getPersonTable3() {
          var self = this,
              gotoNextTable = nil,
              table = nil;
          gotoNextTable = $send(self, 'lambda', [], ($$11 = function (_$$4) {
            function $$11() {
            ...
            return $rb_plus("表４へ", self.$getPersonTable4());
...
//# sourceMappingURL=default~WitchQuest~index.js.map