(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~YankeeYogSothoth~index"],{

/***/ "8zqA":
/*!************************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/YankeeYogSothoth.js ***!
  \************************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $YankeeYogSothoth_initialize$1,
            $YankeeYogSothoth_result_2d6$2,
            $YankeeYogSothoth_eval_game_system_specific_command$3;
        ...
        Opal.def(self, '$initialize', $YankeeYogSothoth_initialize$1 = function $$initialize(command) {
          var $iter = $YankeeYogSothoth_initialize$1.$$p,
              $yield = $iter || nil,
              self = this;
          if ($iter) $YankeeYogSothoth_initialize$1.$$p = null;
          $send2(self, Opal.find_super_dispatcher(self, 'initialize', $YankeeYogSothoth_initialize$1, false, true), 'initialize', [command], null);
          return self.d66_sort_type = $$$($$($nesting, 'D66SortType'), 'ASC');
        }, $YankeeYogSothoth_initialize$1.$$arity = 1);
        Opal.def(self, '$result_2d6', $YankeeYogSothoth_result_2d6$2 = function $$result_2d6(_total, dice_total, _dice_list, cmp_op, _target) {
          var self = this;
          ...
          if ($truthy($rb_le(dice_total, 2))) {
            return $$($nesting, 'Result').$fumble("ファンブル(判定失敗。ファンブル表（FT）を振ること)");
          } else if ($truthy($rb_ge(dice_total, 12))) {
            return $$($nesting, 'Result').$critical("スペシャル(判定成功。【テンション】が１段階上昇)");
          } else {
            return nil;
          }

          ;
        }, $YankeeYogSothoth_result_2d6$2.$$arity = 5);
        Opal.def(self, '$eval_game_system_specific_command', $YankeeYogSothoth_eval_game_system_specific_command$3 = function $$eval_game_system_specific_command(command) {
          var self = this,
              $ret_or_1 = nil;
...
//# sourceMappingURL=default~YankeeYogSothoth~index.js.map