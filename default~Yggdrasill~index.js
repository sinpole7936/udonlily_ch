(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Yggdrasill~index"],{

/***/ "YZSu":
/*!******************************************************************!*\
  !*** ./node_modules/bcdice/lib/bcdice/game_system/Yggdrasill.js ***!
  \******************************************************************/
  ...
  return function ($base, $parent_nesting) {
    ...
    (function ($base, $parent_nesting) {
      ...
      (function ($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting),
            $Yggdrasill_eval_game_system_specific_command$1,
            $Yggdrasill_roll_cf$2,
            $Yggdrasill_count_critical$4,
            $Yggdrasill_count_fumble$6,
            $Yggdrasill_roll_ra$8,
            $Yggdrasill_roll_treat$9,
            $Yggdrasill_roll_down$10,
            $Yggdrasill_roll_cond$11,
            $Yggdrasill_roll_guki$12,
            $Yggdrasill_roll_cont$13,
            $Yggdrasill_roll_allr$14,
            $Yggdrasill_roll_pafe$15;
        self.$$prototype.randomizer = nil;
        Opal.const_set($nesting[0], 'ID', "Yggdrasill");
        Opal.const_set($nesting[0], 'NAME', "鋼鉄のユグドラシル");
        Opal.const_set($nesting[0], 'SORT_KEY', "こうてつのゆくとらしる");
        Opal.const_set($nesting[0], 'HELP_MESSAGE', "" + "■ 行為判定 (CFx+nD6)\n" + "  クリティカルとファンブルによるダイス追加を行う\n" + "  先頭のcfを変更することで、動作が変更される\n" + "  hcf: 達成値が半減\n" + "  cfl: 付加効果【幸運】を付与\n" + "  cfg: 付加効果【ギャンブル】を付与\n" + "  cft: 【応急処置】判定 (tは末尾に記入してください)\n" + "  例）\n" + "    CF10+1D6, HCFL6+2D6, CFG11+1D6-2, cfgt10+1D6\n" + "\n" + "■ 暴走ロール (RAx)\n" + "  暴走率xの暴走ロールおよび臨界ロールを行う\n" + "  例）\n" + "    RA50, RA110, RA150\n" + "\n" + "■ SOペナルティ表 (SOx)\n" + "  スペック数がxオーバーした際のペナルティロールを行う\n" + "  例）\n" + "    SO1, SO5\n" + "\n" + "■ 【応急処置】 (TREATx)\n" + "  達成値xの【応急処置】による回復量を決定する\n" + "  例）\n" + "    TREAT1, TREAT18\n" + "\n" + "■ その他の判定および表\n" + "  down：気絶判定\n" + "  cont：コンティニュー判定\n" + "  risk：リスク判定\n" + "  guki：偶奇判定\n" + "  cond：コンディションロール\n" + "  allr：オールレンジ発動ロール\n" + "  pafe：パーフェクト発動ロール\n" + "  stag：ステージ決定（電脳ロワイヤル用）\n" + "  fatal1：後遺症\n" + "  fatal2：因子変化ロール\n" + "  mikuzi：浅草寺みくじ。1d100であなたの運勢を占います\n");
        self.$register_prefix("H?CF", "RA", "SO", "DOWN", "CO(NT)?", "RISK", "GUKI", "COND", "TREAT", "ALLR", "PAFE", "FATAL", "STAG", "MIKUZI");
        Opal.def(self, '$eval_game_system_specific_command', $Yggdrasill_eval_game_system_specific_command$1 = function $$eval_game_system_specific_command(command) {
          var self = this,
              $ret_or_1 = nil,
              $ret_or_2 = nil,
              $ret_or_3 = nil,
                  ...
                  if ($truthy($ret_or_5 = function () {
                    if ($truthy($ret_or_6 = function () {
                      if ($truthy($ret_or_7 = function () {
                        if ($truthy($ret_or_8 = function () {
                          if ($truthy($ret_or_9 = self.$roll_tables(command, $$($nesting, 'TABLES')))) {
                            return $ret_or_9;
                          } else {
                            return self.$roll_cf(command);
                          }
                        ...
                        return self.$roll_treat(command);
                      }
        ...
        }, $Yggdrasill_eval_game_system_specific_command$1.$$arity = 1);
        self.$private();
        Opal.def(self, '$roll_cf', $Yggdrasill_roll_cf$2 = function $$roll_cf(command) {
          var $a,
              _$$36,
              self = this,
              m = nil,
          ...
          treat_flg = m['$[]'](3)['$nil?']()['$!']();
          expr = m['$[]'](4);
          node = $$$($$$($$($nesting, 'CommonCommand'), 'AddDice'), 'Parser').$parse(expr);
          ...
          ;
          add_dice_randomizer = $$$($$$($$($nesting, 'CommonCommand'), 'AddDice'), 'Randomizer').$new(self.randomizer, self);
          total = node.$lhs().$eval(self, add_dice_randomizer);
          rand_values = $send(self.randomizer.$rand_results(), 'map', [], "first".$to_proc());
          ...
          cr2 = $send(critical_rerolls, 'map', [], (_$$36 = function $$3(x) {
            ...
            ;
            return "" + "[" + x.$join(",") + "]";
          }, _$$36.$$s = self, _$$36.$$arity = 1, _$$36)).$join();
          ...
          ;
          return text;
        }, $Yggdrasill_roll_cf$2.$$arity = 1);
        Opal.def(self, '$count_critical', $Yggdrasill_count_critical$4 = function $$count_critical(dice_list, lucky_state) {
          var _$$37,
              self = this,
              threshold = nil;
          ...
          return $send(dice_list, 'count', [], (_$$37 = function $$5(x) {
          ...
          }, _$$37.$$s = self, _$$37.$$arity = 1, _$$37));
        }, $Yggdrasill_count_critical$4.$$arity = 2);
        Opal.def(self, '$count_fumble', $Yggdrasill_count_fumble$6 = function $$count_fumble(dice_list, lucky_state) {
          var _$$38,
              self = this,
              threshold = nil;
          ...
          return $send(dice_list, 'count', [], (_$$38 = function $$7(x) {
        ...
        }, $Yggdrasill_count_fumble$6.$$arity = 2);
        Opal.def(self, '$roll_ra', $Yggdrasill_roll_ra$8 = function $$roll_ra(command) {
          var $a,
              self = this,
              m = nil,
              body = nil,
          ...
          body = function () {
            $case = ($a = m['$[]'](1), $a === nil || $a == null ? nil : $send($a, 'to_i', []));

            if (50['$===']($case)) {
              return $$($nesting, 'RA50').$roll(self.randomizer);
            } else if (70['$===']($case)) {
              return $$($nesting, 'RA70').$roll(self.randomizer);
            } else if (90['$===']($case)) {
              return $$($nesting, 'RA90').$roll(self.randomizer);
            } else if (110['$===']($case) || 120['$===']($case) || 130['$===']($case) || 140['$===']($case)) {
              return $$($nesting, 'RA110').$roll(self.randomizer);
            } else if (150['$===']($case)) {
              return "＞ 因子崩壊【キャラロスト】";
            } else if (nil['$===']($case)) {
              return "＞ このコマンドは数値を付けてください";
            } else {
              return "＞ 指定の暴走率の暴走ロールはありません";
            }
          }();

          return "" + "(" + command + ") " + body;
        }, $Yggdrasill_roll_ra$8.$$arity = 1);
        Opal.def(self, '$roll_treat', $Yggdrasill_roll_treat$9 = function $$roll_treat(command) {
          var $a,
              self = this,
              m = nil,
              value = nil,
          ...
          ;
          value = ($a = m['$[]'](1), $a === nil || $a == null ? nil : $send($a, 'to_i', []));

          recovery = function () {
            if ($truthy($rb_le(value, 5))) {
              return 0;
            } else if ($truthy($rb_le(value, 7))) {
              return 1;
            } else if ($truthy($rb_le(value, 11))) {
              dice = self.randomizer.$roll_once(6);
              total = $rb_divide(dice, 2).$to_i();
              return "" + total + "(" + dice + "[" + dice + "]/2)";
            } else if ($truthy($rb_le(value, 14))) {
              dice = self.randomizer.$roll_once(6);
              return "" + dice + "(" + dice + "[" + dice + "])";
            } else if ($truthy($rb_le(value, 17))) {
              dice = self.randomizer.$roll_once(6);
              total = $rb_plus(dice, 3);
              return "" + total + "(" + dice + "[" + dice + "]+3)";
            } else {
              list = self.randomizer.$roll_barabara(2, 6);
              dice = list.$sum();
              total = $rb_plus(dice, 2);
              return "" + total + "(" + dice + "[" + list.$join(",") + "]+2)";
            }
        ...
        }, $Yggdrasill_roll_treat$9.$$arity = 1);
        Opal.def(self, '$roll_down', $Yggdrasill_roll_down$10 = function $$roll_down(command) {
          var self = this,
              dice = nil,
              result = nil,
              fell = nil;

          if (command['$==']("DOWN")) {} else {
            return nil;
          }
          ...
          result = function () {
            if ($truthy(dice['$even?']())) {
              ...
              fell = self.randomizer.$roll_once(6);
              return "" + "気絶【" + fell + "R行動不能】";
            }
        ...
        }, $Yggdrasill_roll_down$10.$$arity = 1);
        Opal.def(self, '$roll_cond', $Yggdrasill_roll_cond$11 = function $$roll_cond(command) {
          var self = this,
              hp_list = nil,
              hp_total = nil,
              hp_str = nil,
        ...
        }, $Yggdrasill_roll_cond$11.$$arity = 1);
        Opal.def(self, '$roll_guki', $Yggdrasill_roll_guki$12 = function $$roll_guki(command) {
          var self = this,
              dice = nil,
              result = nil;

          if (command['$==']("GUKI")) {} else {
            return nil;
          }
        ...
        }, $Yggdrasill_roll_guki$12.$$arity = 1);
        Opal.def(self, '$roll_cont', $Yggdrasill_roll_cont$13 = function $$roll_cont(command) {
          var self = this,
              dice = nil,
              text = nil;

          if ($truthy(/CO(NT)?/['$match?'](command))) {} else {
            return nil;
          }
        ...
        }, $Yggdrasill_roll_cont$13.$$arity = 1);
        Opal.def(self, '$roll_allr', $Yggdrasill_roll_allr$14 = function $$roll_allr(command) {
          var self = this,
              dice = nil,
              text = nil;

          if (command['$==']("ALLR")) {} else {
            return nil;
          }
        ...
        }, $Yggdrasill_roll_allr$14.$$arity = 1);
        Opal.def(self, '$roll_pafe', $Yggdrasill_roll_pafe$15 = function $$roll_pafe(command) {
          var self = this,
              dice = nil,
              text = nil;

          if (command['$==']("PAFE")) {} else {
            return nil;
          }
          ...
          text = function () {
            if (dice['$=='](1)) {
              return "発動失敗【通常命中・回避判定となり、発動時のアクション内の命中力＆回避力が半減する】";
            } else {
              return "発動成功";
            }
        ...
        }, $Yggdrasill_roll_pafe$15.$$arity = 1);

        (function ($base, $super, $parent_nesting) {
          var self = $klass($base, $super, 'YggTable');
          var $nesting = [self].concat($parent_nesting),
              $YggTable_initialize$16,
              $YggTable_roll$17;
          self.$$prototype.times = self.$$prototype.sides = self.$$prototype.index = self.$$prototype.out_of_control = self.$$prototype.additonal_times = self.$$prototype.additonal_sides = self.$$prototype.format = nil;
          Opal.def(self, '$initialize', $YggTable_initialize$16 = function $$initialize(name, type, items, $kwargs) {
            var additonal_type,
                additonal_format,
                additonal_index,
                out_of_control,
                $iter = $YggTable_initialize$16.$$p,
                $yield = $iter || nil,
                self = this,
                m = nil;
            if ($iter) $YggTable_initialize$16.$$p = null;
            ...
            if (!Opal.hasOwnProperty.call($kwargs.$$smap, 'additonal_type')) {
              throw Opal.ArgumentError.$new('missing keyword: additonal_type');
            }

            additonal_type = $kwargs.$$smap["additonal_type"];
            ;

            if (!Opal.hasOwnProperty.call($kwargs.$$smap, 'additonal_format')) {
              throw Opal.ArgumentError.$new('missing keyword: additonal_format');
            }

            additonal_format = $kwargs.$$smap["additonal_format"];
            ;

            if (!Opal.hasOwnProperty.call($kwargs.$$smap, 'additonal_index')) {
              throw Opal.ArgumentError.$new('missing keyword: additonal_index');
            }

            additonal_index = $kwargs.$$smap["additonal_index"];
            ;
            out_of_control = $kwargs.$$smap["out_of_control"];

            if (out_of_control == null) {
              out_of_control = nil;
            }

            ;
            $send2(self, Opal.find_super_dispatcher(self, 'initialize', $YggTable_initialize$16, false, true), 'initialize', [name, type, items], null);
            m = /(\d+)D(\d+)/i.$match(additonal_type);

            if ($truthy(m)) {} else {
              self.$raise($$($nesting, 'ArgumentError'), "" + "Unexpected table type: " + additonal_type);
            }
          ...
          }, $YggTable_initialize$16.$$arity = 4);
          return (Opal.def(self, '$roll', $YggTable_roll$17 = function $$roll(randomizer) {
            var self = this,
                value = nil,
                chosen = nil,
                $ret_or_10 = nil,
            ...
            if ($truthy(function () {
              if ($truthy($ret_or_10 = self.index['$include?'](value))) {
                return $ret_or_10;
              } else {
                return self.out_of_control['$=='](value);
              }
            ...
            body = function () {
              if (self.out_of_control['$=='](value)) {
                return "" + chosen.$body() + " ： " + $$($nesting, 'RA90').$roll(randomizer);
              } else {
                list = randomizer.$roll_barabara(self.additonal_times, self.additonal_sides);
                return $rb_plus(chosen.$body(), self.$format(self.format, $hash2(["total", "list"], {
                  "total": list.$sum(),
                  "list": list.$join(",")
                })));
              }
            ...
            return $$$($$($nesting, 'DiceTable'), 'RollResult').$new(chosen.$table_name(), chosen.$value(), body);
          }, $YggTable_roll$17.$$arity = 1), nil) && 'roll';
        })($nesting[0], $$$($$($nesting, 'DiceTable'), 'Table'), $nesting);

        (function ($base, $super, $parent_nesting) {
          var self = $klass($base, $super, 'ChainTable');
          var $nesting = [self].concat($parent_nesting),
              $ChainTable_initialize$18,
              $ChainTable_roll$19;
          self.$$prototype.times = self.$$prototype.sides = self.$$prototype.index = self.$$prototype.additonal_table = nil;
          Opal.def(self, '$initialize', $ChainTable_initialize$18 = function $$initialize(name, type, items, $kwargs) {
            var additonal_table,
                additonal_index,
                $iter = $ChainTable_initialize$18.$$p,
                $yield = $iter || nil,
                self = this;
            if ($iter) $ChainTable_initialize$18.$$p = null;
            ...
            if (!Opal.hasOwnProperty.call($kwargs.$$smap, 'additonal_table')) {
              throw Opal.ArgumentError.$new('missing keyword: additonal_table');
            }

            additonal_table = $kwargs.$$smap["additonal_table"];
            ;
            ...
            additonal_index = $kwargs.$$smap["additonal_index"];
            ;
            $send2(self, Opal.find_super_dispatcher(self, 'initialize', $ChainTable_initialize$18, false, true), 'initialize', [name, type, items], null);
            self.additonal_table = additonal_table;
            return self.index = additonal_index;
          }, $ChainTable_initialize$18.$$arity = 4);
          return (Opal.def(self, '$roll', $ChainTable_roll$19 = function $$roll(randomizer) {
            var self = this,
                value = nil,
                chosen = nil,
                body = nil;
            ...
            if ($truthy(self.index['$include?'](value))) {} else {
              return chosen;
            }
            ...
            return $$$($$($nesting, 'DiceTable'), 'RollResult').$new(chosen.$table_name(), chosen.$value(), body);
          }, $ChainTable_roll$19.$$arity = 1), nil) && 'roll';
        })($nesting[0], $$$($$($nesting, 'DiceTable'), 'Table'), $nesting);

        Opal.const_set($nesting[0], 'PSY_TABLE', $$$($$($nesting, 'DiceTable'), 'Table').$new("能力タイプ", "1D6", ["サイキッカー", "エスパー", "トランサー", "クリエイター", "アンノウン", "好きな能力タイプを選択。ノーマル選択でも可"]));
        Opal.const_set($nesting[0], 'RA50', $$($nesting, 'YggTable').$new("暴走Lv.1", "1D6", ["発作【自爆÷2ダメージ。（自身に能力攻撃ロールダメージ÷2）。防御無視】", "高揚【1D6暴走率上昇】", "高揚【1D6暴走率上昇】", "自制【暴走なし】", "自制【暴走なし】", "自制【暴走なし】"], $hash2(["additonal_type", "additonal_format", "additonal_index"], {
          "additonal_type": "1D6",
          "additonal_format": " ： %{total}[%{list}] ％",
          "additonal_index": [2, 3]
        })));
        Opal.const_set($nesting[0], 'RA70', $$($nesting, 'YggTable').$new("暴走Lv.3", "1D6", ["自爆【自爆ダメージ。自身に能力攻撃ロールダメージ。防御無視】", "自爆【自爆ダメージ。自身に能力攻撃ロールダメージ。防御無視】", "暴発【ランダム攻撃。基本的に能力攻撃。対象は自分、キャラ、オブジェクトの三種類】", "連鎖【2D6暴走率上昇】", "発症", "自制【暴走無し】"], $hash2(["additonal_type", "additonal_format", "additonal_index", "out_of_control"], {
          "additonal_type": "2D6",
          "additonal_format": " ： %{total}[%{list}] ％",
          "additonal_index": [4],
          "out_of_control": 5
        })));
        Opal.const_set($nesting[0], 'RA90', $$$($$($nesting, 'DiceTable'), 'D66ParityTable').$new("暴走状態表", ["能力異常【能力使用時に偶奇判定。奇数の場合は消費だけ行い能力発動失敗。暴走チェックごとに+2％される（発症時も発生）。能力精度の判定結果が半減】", "言語異常【AE使用時に偶奇判定。奇数の場合は消費だけ行いAE発動失敗。話術の判定結果が半減】", "記憶異常【命中判定結果が半減する。知識の判定結果が半減】", "精神異常【自分のリアクション（回避判定など）で偶奇判定。奇数の場合は行動自動失敗。隠密、読心の判定結果が半減】", "忘我【自プリアクション時に偶奇判定。奇数の場合は宣言せずにターン終了。あらゆる技能判定結果が半減】", "自制【暴走無し】"], ["制御異常【自プリアクション毎（行動決定前）に偶奇判定。奇数の場合は暴発によるランダム攻撃。（発症時も発生）。技術、幸運の判定結果が半減】", "過負荷【ワンアクション毎に能力精度÷3の防御無視ダメージ（発症時も発生）。閃きの判定結果が半減】", "聴覚異常【回避判定結果が半減する。察知の半減結果が半減】", "視覚異常【SS＆命中力＆回避力が半減する※判定結果は半減しない。観察眼の判定結果が半減】", "身体異常【防御を差し引く前のダメージロールが半減する。力技、俊敏の判定結果が半減】", "自制【暴走なし】"]));
        Opal.const_set($nesting[0], 'RA110', $$($nesting, 'YggTable').$new("臨界ロール", "1D6", ["自壊【自爆ダメージ。自身の最も高い攻撃ロールダメージ。防御無視】", "超活性【HP・PPを2D6回復】", "自壊【自爆ダメージ。自身の最も高い攻撃ロールダメージ。防御無視】", "超活性【HP・PPを2D6回復】", "自壊【自爆ダメージ。自身の最も高い攻撃ロールダメージ。防御無視】", "超活性【HP・PPを2D6回復】"], $hash2(["additonal_type", "additonal_format", "additonal_index"], {
          "additonal_type": "2D6",
          "additonal_format": " ： %{total}[%{list}] 回復",
          "additonal_index": [2, 4, 6]
        })));
        return Opal.const_set($nesting[0], 'TABLES', $hash2(["MIKUZI", "SO1", "SO2", "SO3", "SO4", "SO5", "RISK", "FATAL1", "FATAL2", "STAG"], {
          "MIKUZI": $$$($$($nesting, 'DiceTable'), 'RangeTable').$new("おみくじ", "1D100", [[$range(1, 17, false), "大吉"], [$range(18, 52, false), "吉"], [$range(53, 57, false), "半吉"], [$range(58, 61, false), "小吉"], [$range(62, 64, false), "末小吉"], [$range(65, 70, false), "末吉"], [$range(71, 100, false), "凶"]]),
          "SO1": $$($nesting, 'YggTable').$new("SOペナルティ表 1オーバー", "1D6", ["消費負荷【ＰＰ２倍消費　※ＡＥ消費は含まない】", "消費負荷【ＰＰ２倍消費　※ＡＥ消費は含まない】", "消費負荷【ＰＰ２倍消費　※ＡＥ消費は含まない】", "反動", "反動", "制御成功【発動成功　ペナルティ無し】"], $hash2(["additonal_type", "additonal_format", "additonal_index"], {
            "additonal_type": "1D6",
            "additonal_format": "【命中＆回避－１Ｄ６（%{total}[%{list}]）　１ラウンド継続】",
            "additonal_index": [4, 5]
          })),
          "SO2": $$($nesting, 'YggTable').$new("SOペナルティ表 2オーバー", "1D6", ["自爆【自分へ能力攻撃ダメージ　※防御無視】", "消費負荷【ＰＰ２倍消費　※ＡＥ消費は含まない】", "消費負荷【ＰＰ２倍消費　※ＡＥ消費は含まない】", "反動", "反動", "制御成功【発動成功　ペナルティ無し】"], $hash2(["additonal_type", "additonal_format", "additonal_index"], {
            "additonal_type": "1D6",
            "additonal_format": "【命中＆回避－１Ｄ６（%{total}[%{list}]）　１ラウンド継続】",
            "additonal_index": [4, 5]
          })),
          "SO3": $$($nesting, 'YggTable').$new("SOペナルティ表 3オーバー", "1D6", ["自爆【自分へ能力攻撃ダメージ　※防御無視】", "自爆【自分へ能力攻撃ダメージ　※防御無視】", "消費負荷【ＰＰ２倍消費　※ＡＥ消費は含まない】", "過反動", "過反動", "制御成功【発動成功　ペナルティ無し】"], $hash2(["additonal_type", "additonal_format", "additonal_index"], {
            "additonal_type": "2D6",
            "additonal_format": "【命中＆回避－２Ｄ６（%{total}[%{list}]）　１ラウンド継続】",
            "additonal_index": [4, 5]
          })),
          "SO4": $$($nesting, 'YggTable').$new("SOペナルティ表 4オーバー", "1D6", ["崩壊【自爆ダメージ×２　※防御無視】", "崩壊【自爆ダメージ×２　※防御無視】", "超負荷【ＰＰ３倍消費　※ＡＥ消費は含まない】", "過反動", "過反動", "制御成功【発動成功　ペナルティ無し】"], $hash2(["additonal_type", "additonal_format", "additonal_index"], {
            "additonal_type": "2D6",
            "additonal_format": "【命中＆回避－２Ｄ６（%{total}[%{list}]）　１ラウンド継続】",
            "additonal_index": [4, 5]
          })),
          "SO5": $$$($$($nesting, 'DiceTable'), 'Table').$new("SOペナルティ表 5オーバー", "1D6", ["崩壊【自爆ダメージ×２　※防御無視】", "崩壊【自爆ダメージ×２　※防御無視】", "崩壊【自爆ダメージ×２　※防御無視】", "超負荷【ＰＰ３倍消費　※ＡＥ消費は含まない】", "超負荷【ＰＰ３倍消費　※ＡＥ消費は含まない】", "制御成功【発動成功　ペナルティ無し】"]),
          "RISK": $$$($$($nesting, 'DiceTable'), 'Table').$new("リスク判定", "1D6", ["能力自爆【能力は発動せず、ＰＰを２倍消費する。併用ＡＥのＰＰは含まない。それに加え【自爆】する。能力攻撃力分を自身へ防御無視ダメージ】", "能力不発【能力は発動せず、ＰＰを２倍消費する。併用ＡＥのＰＰは含まない】", "効果不発【リスクの効果はゼロで能力発動】", "通常発動【（能力精度÷３）＋１Ｄ６を加える】", "活性発動【（能力精度÷３）＋２Ｄ６を加える】", "覚醒発動【（能力精度÷３）＋３Ｄ６を加える】"]),
          "FATAL1": $$$($$($nesting, 'DiceTable'), 'Table').$new("後遺症判定", "1D6", ["聴覚崩壊【聴覚に異常が起きる。幻聴、難聴、失聴、など】", "視覚崩壊【視覚に異常が起こる。幻覚、色盲、失明、など】", "言語崩壊【言語の認識に異常が起きる。しゃべる事に支障をきたす。吃音、失語症、失読症、など】", "身体崩壊【身体に異常が起こる。欠損、異形化、麻痺、など】", "精神崩壊【精神に異常が起こる。人格破綻、性格変化、妄想・幻覚による異常行動、など】", "記憶崩壊【記憶に異常が起こる。記憶障害、記憶喪失、など】"]),
          "FATAL2": $$($nesting, 'ChainTable').$new("因子変化判定", "1D6", ["能力変化【能力がまったく別ものに変化する】", "能力変化【能力がまったく別ものに変化する】", "因子抑制【能力変化は起こらない】", "因子抑制【能力変化は起こらない】", "能力喪失・能力覚醒【能力を持つものは失い、ノーマルは能力に覚醒する。喪失者はノーマルのキャラ特性ポイントを1p獲得する。覚醒者はノーマルのキャラ特性ポイントを1p失い、キャラ特性を6つ取得していた場合は1つ喪失する】", "能力喪失・能力覚醒【能力を持つものは失い、ノーマルは能力に覚醒する。喪失者はノーマルのキャラ特性ポイントを1p獲得する。覚醒者はノーマルのキャラ特性ポイントを1p失い、キャラ特性を6つ取得していた場合は1つ喪失する】"], $hash2(["additonal_table", "additonal_index"], {
            "additonal_table": $$($nesting, 'PSY_TABLE'),
            "additonal_index": [1, 2, 5, 6]
          })),
          "STAG": $$$($$($nesting, 'DiceTable'), 'D66Table').$new("ステージ決定", $$$($$($nesting, 'D66SortType'), 'NO_SORT'), $hash(11, "ロシアンルーレット【幸運にて判定。参加者は銃をこめかみにあて、１発の銃弾をひかないように祈る。 敗者は３Ｄ６ダメージ】", 12, "チキンレース【察知にて判定。に向ってバイクでダッシュだ。敗者は２Ｄ６ダメージ。落ちても大丈夫です、電脳だから】", 13, "取り立て【力技or威圧にて判定。あのモヒカン借金払わないんですよ。よろしくお願いしますね。電脳を通しての実際の取り立てらしい】", 14, "舌戦【威圧or話術にて判定。参加者同士で舌戦で勝者を決めろ！敗者は心に２Ｄ６ダメージ】", 15, "ギャンブル【読心or幸運にて判定。ポーカー、ルーレット、麻雀、好きなものを選べ。勝利の鍵は運か、それとも人の心か】", 16, "トラップ【ＳＳにて判定。君達の目の前に広がるのはそう、地雷原だ。敗者は３Ｄ６ダメージ】", 21, "サバゲー【隠密or俊敏にて判定。軍人となって、相手を屠れ！敗者は死ぬ。敗者は２Ｄ６ダメージ】", 22, "追跡【察知or隠密にて判定。ニンジャの姿となって下手人を追え！コアな人気を誇るステージ。ニンジャ人気すごい】", 23, "推理【閃きにて判定。あなたたちは探偵となり、事件を解決に導く。犯人は、お前だ！２時間放送になるのが玉に瑕】", 24, "潜入【隠密にて判定。スパイとなり、機密情報を盗め！あれ、これ実際の企業の機密情報じゃ・・・？】", 25, "かくれんぼ【隠密or読心にて判定。あなたを追うのはホラーな化け物・・・。スリリングなかくれんぼをどうぞ堪能下さい】", 26, "絶対絶命！【回避力にて判定。君達はマフィアにおびき出されたのだ。大勢の銃が君を狙う。敗者は３Ｄ６ダメージ】", 31, "クイズ【知識にて判定。己の知識を存分に披露しろ！負けたら奈落に落されます。敗者は１Ｄ６ダメージ】", 32, "迷路【察知or幸運にて判定。巨大迷路をクリアしろ！あれ、なんでこんなところに骸骨が・・・】", 33, "パズル【知識or閃きにて判定。３Ｄの難解パズルを解き明かせ！！時折金庫破りのパスワードがターゲットになってたり】", 34, "間違い探し【観察眼or閃きにて判定。大量の鍵から正しい鍵を。美女の中からオカマを。そんな間違いを見つけるのだ！】", 35, "目利き【観察眼or知識にて判定。あなたの鑑定で値段を当てろ！はずれたらかっこ悪いです】", 36, "スナイパー【命中力にて判定。一撃必殺でターゲットを仕留めろ！なお、ターゲットはお互いだ。敗者は２Ｄ６ダメージ】", 41, "腕相撲【力技にて判定。必要なのは、力のみ！！敗者は２Ｄ６ダメージ】", 42, "インディジョーンズ【俊敏にて判定。なぜか大岩が後ろから！逃げろー！敗者は３Ｄ６ダメージ】", 43, "ＰＫ【力技or察知にて判定。見極め、ゴールしろ！パワーで破ってもいい】", 44, "ダンス【技術or俊敏にて判定。己の舞を魅せろ！ジャンル問わず】", 45, "ボディコンテスト【威圧にて判定。魅せるのはマッスルか、それとも美しい肢体か！容姿ボーナスはつきません】", 46, "突破しろ！【ダメージ量にて判定。立ちはだかる扉をぶち破れ！扉は防御１０】", 51, "早食い【力技or俊敏にて判定。くって！くって！！くいまくれ！！敗者は胃に２Ｄ６ダメージ】", 52, "ナンパ天国【話術or読心にて判定。電脳世界で老若男女を口説き落せ！相手はプログラムだったり電脳に入っているアバターだったり】", 53, "スリーサイズ【観察眼にて判定。魅惑のボディをなめまわせ！勝利者はある意味で尊敬され、ある意味で嫌われる】", 54, "ワサビ寿司【観察眼or幸運にて判定。高級寿司の中に、死ぬほどの刺激が・・・！敗者は２Ｄ６ダメージ】", 55, "じゃんけん【読心にて判定。じゃんけんとは運ではない、読み合いなのだ！】", 56, "瓦割り【ダメージ量にて判定。どんな方法でもいい。とにかく枚数を割れ！！！ダメージ量の２倍くらいが割った枚数】", 61, "料理対決【知識or技術にて判定。胃袋をつかめ！絶品料理対決！料理によってはＲ１８Ｇ指定になる場合がある】", 62, "歌合戦【威圧or技術にて判定。その歌唱力で心をつかめ！アイドルデビューも夢じゃない！電脳なのでお好きな衣装でどうぞ】", 63, "漫才【話術or閃きにて判定。即興漫才で画面の向こうを爆笑の渦へ！相方が必要な方は漫才プログラムアバターをレンタル。有料】", 64, "画伯【技術にて判定。テーマをもとに、あなたの画力を見せつけろ！時々下手うまな人が勝つことも】", 65, "プレゼンテーション【話術にて判定。本日の商品は、こちら！！実際に販売します。してもらいます】", 66, "無双撃破！【ダメージ量にて判定。た、大量のモヒカンだぁ～！ダメージ量の２倍くらいが倒した数。敗者は２Ｄ６ダメージ。ＳＥ【オールレンジ】技は成功で判定＋１０】"))
        }).$freeze());
...
//# sourceMappingURL=default~Yggdrasill~index.js.map